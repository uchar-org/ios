...
struct InviteUsersConfirmationSheetView_Previews: PreviewProvider, TestablePreview {
  ...
  static var previews: some View {
    InviteUsersConfirmationSheetView(
      context: viewModel.context, users: [.mockAlice, .mockCharlie, .mockBob, .mockDan]
    )
  ...
  static func makeViewModel() -> InviteUsersScreenViewModel {
    let viewModel = InviteUsersScreenViewModel(
      userSession: UserSessionMock(.init(clientProxy: ClientProxyMock(.init()))),
