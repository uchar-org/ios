...
struct SecureBackupRecoveryKeyScreenViewState: BindableState {
    ...
    var title: String {
        ...
        case .changeRecovery:
            return recoveryKey == nil
                ? L10n.screenRecoveryKeyChangeTitle : L10n.screenRecoveryKeySaveTitle
        case .fixRecovery:
    ...
    var subtitle: String? {
        ...
        case .setupRecovery:
            return recoveryKey == nil
                ? L10n.screenRecoveryKeySetupDescription : L10n.screenRecoveryKeySaveDescription
        case .changeRecovery:
            return recoveryKey == nil
                ? L10n.screenRecoveryKeyChangeDescription : L10n.screenRecoveryKeySaveDescription
        case .fixRecovery:
    ...
    var recoveryKeySubtitle: String? {
        ...
        case .setupRecovery:
            return recoveryKey == nil
                ? L10n.screenRecoveryKeySetupGenerateKeyDescription
                : L10n.screenRecoveryKeySaveKeyDescription
        case .changeRecovery:
            return recoveryKey == nil
                ? L10n.screenRecoveryKeyChangeGenerateKeyDescription
                : L10n.screenRecoveryKeySaveKeyDescription
        case .fixRecovery:
