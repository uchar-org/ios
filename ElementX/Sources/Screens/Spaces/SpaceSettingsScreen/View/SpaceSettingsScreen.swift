...
struct SpaceSettingsScreen: View {
  ...
  private var editRowContent: some View {
    HStack(spacing: 12) {
      RoomAvatarImage(
        avatar: context.viewState.details.avatar,
  ...
  private var securitySection: some View {
    Section {
      ListRow(
        label: .default(title: L10n.screenSpaceSettingsSecurityAndPrivacy, icon: \.lock),
        kind: .navigationLink {
  ...
  private var peopleSection: some View {
    Section {
      ...
      if context.viewState.canEditRolesOrPermissions {
        ListRow(
          label: .default(title: L10n.screenSpaceSettingsRolesAndPermissions, icon: \.admin),
          kind: .navigationLink {
...
struct SpaceSettingsScreen_Previews: PreviewProvider, TestablePreview {
  static let ownerViewModel = RoomDetailsScreenViewModel(
  ...
  static let userViewModel = RoomDetailsScreenViewModel(
    roomProxy: JoinedRoomProxyMock(
      .init(
        name: "Space",
        avatarURL: .mockMXCAvatar,
