...
typealias GlobalSearchScreenViewModelType = StateStoreViewModel<
  GlobalSearchScreenViewState, GlobalSearchScreenViewAction
>

class GlobalSearchScreenViewModel: GlobalSearchScreenViewModelType,
  GlobalSearchScreenViewModelProtocol
{
  ...
  init(
    ...
    super.init(
      initialViewState: GlobalSearchScreenViewState(bindings: .init(searchQuery: "")),
