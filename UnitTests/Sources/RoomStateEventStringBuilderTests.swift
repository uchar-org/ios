...
struct RoomStateEventStringBuilderTests {
    ...
    func kickMember() {
        ...
        string = stringBuilder.buildString(for: .kicked,
                                           ...
                                           isOutgoing: false)
        #expect(string
            == L10n.stateEventRoomRemoveWithReason(other.displayName ?? other.id, banned.displayName ?? banned.id, reason))
        string = stringBuilder.buildString(for: .kicked,
                                           reason: nil,
                                           memberUserID: banned.id,
                                           memberDisplayName: banned.displayName,
    ...
    func banMember() {
        ...
        string = stringBuilder.buildString(for: .banned,
                                           ...
                                           isOutgoing: false)
        #expect(string
            == L10n.stateEventRoomBanWithReason(other.displayName ?? other.id, banned.displayName ?? banned.id, reason))
        string = stringBuilder.buildString(for: .banned,
                                           reason: nil,
                                           memberUserID: banned.id,
                                           memberDisplayName: banned.displayName,
