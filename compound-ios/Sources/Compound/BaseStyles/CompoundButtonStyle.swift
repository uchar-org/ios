...
extension ButtonStyle where Self == CompoundButtonStyle {
  ...
  public static func compound(_ kind: Self.Kind, size: Self.Size = .large) -> CompoundButtonStyle {
...
public struct CompoundButtonStyle: ButtonStyle {
  ...
  private func strokeColor(configuration: Self.Configuration) -> Color {
    if configuration.role == .destructive {
      ...
      return .compound.borderInteractiveSecondary.opacity(
  ...
  private func textColor(configuration: Configuration) -> Color {
    if kind == .primary {
      ...
      let textColor: Color =
        ...
        ? .compound.textCriticalPrimary : .compound.textActionPrimary
