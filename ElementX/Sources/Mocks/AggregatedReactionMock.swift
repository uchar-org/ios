...
extension AggregatedReaction {
  ...
  static var mockReactionWithLongText: AggregatedReaction {
    mockReaction(
      key: "Matrix defines a set of open APIs for decentralised communication.", senderIDs: [alice])
  }

  static var mockReactionWithLongTextRTL: AggregatedReaction {
    mockReaction(
      key: "تحدد المصفوفة مجموعة من واجهات برمجة التطبيقات المفتوحة للتواصل اللامركزي.",
      senderIDs: [alice])
  }
}
