...
enum TimelineControllerAction {
  ...
  case displayMediaPreview(
    item: EventBasedMessageTimelineItemProtocol, timelineViewModel: TimelineViewModelKind)
...
protocol TimelineControllerProtocol {
  ...
  func toggleReaction(
    _ reaction: String, to eventOrTransactionID: TimelineItemIdentifier.EventOrTransactionID) async
  ...
  func messageEventContent(for itemID: TimelineItemIdentifier) async
