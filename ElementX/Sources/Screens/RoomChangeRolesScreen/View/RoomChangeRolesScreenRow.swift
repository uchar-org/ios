...
struct RoomChangeRolesScreenRow_Previews: PreviewProvider, TestablePreview {
  ...
  static var previews: some View {
    Form {
      ...
      RoomChangeRolesScreenRow(
        member: .init(withProxy: RoomMemberProxyMock.mockBob),
        mediaProvider: MediaProviderMock(configuration: .init()),
        isSelected: false,
        action: action)

      RoomChangeRolesScreenRow(
        member: .init(withProxy: RoomMemberProxyMock.mockInvited),
        mediaProvider: MediaProviderMock(configuration: .init()),
        isSelected: false,
        action: action)

      RoomChangeRolesScreenRow(
        member: .init(withProxy: RoomMemberProxyMock.mockCharlie),
        mediaProvider: MediaProviderMock(configuration: .init()),
        isSelected: true,
        action: action
      )
