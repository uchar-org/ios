...
struct ServerSelectionScreenViewModelTests {
  ...
  mutating func invalidServer() async throws {
    ...
    setup(authenticationFlow: .login)
    #expect(
      !context.viewState.isShowingFooterError,
      "There should not be an error message for a new view model.")
    #expect(
      context.viewState.footerErrorMessage == nil,
      "There should not be an error message for a new view model.")
    #expect(
      String(context.viewState.footerMessage) == L10n.screenChangeServerFormNotice,
    ...
    #expect(
      context.viewState.footerErrorMessage == nil, "The error message should have been cleared.")
    #expect(
      String(context.viewState.footerMessage) == L10n.screenChangeServerFormNotice,
  ...
  private mutating func setup(authenticationFlow: AuthenticationFlow) {
    ...
    viewModel = ServerSelectionScreenViewModel(
