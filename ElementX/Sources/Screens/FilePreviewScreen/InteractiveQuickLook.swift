...
extension View {
  ...
  func interactiveQuickLook(item: Binding<MediaPreviewItem?>, allowEditing: Bool = true)
    -> some View
  {
...
private struct MediaPreviewViewController: UIViewControllerRepresentable {
  ...
  class PreviewHostingController: UIViewController, QLPreviewControllerDataSource,
    QLPreviewControllerDelegate
  {
    ...
    func previewController(
      _ controller: QLPreviewController, transitionViewFor item: any QLPreviewItem
    ) -> UIView? {
      sourceView
    }
...
struct PreviewView_Previews: PreviewProvider {
  ...
  static let previewItem = MediaPreviewItem(
    file: .unmanaged(url: previewURL),
