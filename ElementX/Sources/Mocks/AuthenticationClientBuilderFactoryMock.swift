...
extension AuthenticationClientFactoryMock {
  struct Configuration {
    var homeserverClients = [
      ...
      "company.com": ClientSDKMock(
        configuration: .init(
          serverAddress: "company.com",
          homeserverURL: "https://matrix.company.com",
          slidingSyncVersion: .native,
          oidcLoginURL: "https://auth.company.com/oidc",
          supportsOIDCCreatePrompt: false,
          supportsPasswordLogin: false)),
      "server.net": ClientSDKMock(
        configuration: .init(
          serverAddress: "server.net",
          homeserverURL: "https://matrix.server.net",
          slidingSyncVersion: .native,
          oidcLoginURL: nil,
          supportsOIDCCreatePrompt: false,
          supportsPasswordLogin: false)),
      "secure.gov": ClientSDKMock(
        configuration: .init(
          serverAddress: "secure.gov",
