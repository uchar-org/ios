...
struct NavigationSplitCoordinatorTests {
    ...
    func splitTracksEmbeddedStackRootChanges() async {
        ...
        assertCoordinatorsEqual(sidebarNavigationStackCoordinator.rootCoordinator,
    ...
    func splitTracksEmbeddedStackChanges() async {
        ...
        await waitForConfirmation("Coordinators should match", timeout: .seconds(1)) { confirm in
            DispatchQueue.main.async {
                #expect(sidebarNavigationStackCoordinator.stackCoordinators.count
                ...
                for index in sidebarNavigationStackCoordinator.stackCoordinators.indices {
                    assertCoordinatorsEqual(sidebarNavigationStackCoordinator.stackCoordinators[index],
    ...
    func compactStackCreation() async {
        ...
        await waitForConfirmation("Coordinators should match", timeout: .seconds(1)) { confirm in
            DispatchQueue.main.async {
                assertCoordinatorsEqual(navigationSplitCoordinator.compactLayoutRootCoordinator,
                                        sidebarCoordinator.rootCoordinator)
                assertCoordinatorsEqual(navigationSplitCoordinator.compactLayoutStackModules[0].coordinator,
                                        sidebarCoordinator.stackCoordinators.first)
                assertCoordinatorsEqual(navigationSplitCoordinator.compactLayoutStackModules[1].coordinator,
                                        detailCoordinator.rootCoordinator)
                assertCoordinatorsEqual(navigationSplitCoordinator.compactLayoutStackModules[2].coordinator,
                                        detailCoordinator.stackCoordinators.first)
                assertCoordinatorsEqual(navigationSplitCoordinator.compactLayoutStackModules[3].coordinator,
