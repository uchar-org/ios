...
class PostHogAnalyticsClient: AnalyticsClientProtocol {
    ...
    func capture(_ event: AnalyticsEventProtocol) {
        ...
        postHog?.capture(event.eventName, properties: attachSuperProperties(to: event.properties),
    ...
    func updateSuperProperties(_ updatedProperties: AnalyticsEvent.SuperProperties) {
        ...
        superProperties = AnalyticsEvent.SuperProperties(appPlatform: updatedProperties.appPlatform ?? currentProperties.appPlatform,
