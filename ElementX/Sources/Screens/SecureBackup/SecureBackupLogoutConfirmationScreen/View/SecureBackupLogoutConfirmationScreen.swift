...
struct SecureBackupLogoutConfirmationScreen_Previews: PreviewProvider, TestablePreview {
    ...
    static var previews: some View {
        ...
        .snapshotPreferences(expect: waitingViewModel.context.observe(\.viewState.mode).map {
        ...
        .snapshotPreferences(expect: ongoingViewModel.context.observe(\.viewState.mode).map {
