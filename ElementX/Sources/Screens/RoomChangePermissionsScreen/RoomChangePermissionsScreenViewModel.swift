...
class RoomChangePermissionsScreenViewModel: RoomChangePermissionsScreenViewModelType,
    ...
    private func trackChanges(_ settings: [RoomPermissionsSetting]) {
        for setting in settings {
            ...
            case \.invite:
                analytics.trackRoomModeration(action: .ChangePermissionsInviteUsers, role: setting.roleValue)
            case \.kick:
                analytics.trackRoomModeration(action: .ChangePermissionsKickMembers, role: setting.roleValue)
            case \.redact:
                analytics.trackRoomModeration(action: .ChangePermissionsRedactMessages, role: setting.roleValue)
            case \.eventsDefault:
                analytics.trackRoomModeration(action: .ChangePermissionsSendMessages, role: setting.roleValue)
            case \.roomName:
