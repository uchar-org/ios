...
extension View {
  ...
  public func scaledFrame(
    size: CGFloat, alignment: Alignment = .center, relativeTo textStyle: Font.TextStyle = .body
  ) -> some View {
  ...
  public func scaledFrame(
    width: CGFloat, height: CGFloat, alignment: Alignment = .center,
    relativeTo textStyle: Font.TextStyle = .body
  ) -> some View {
    modifier(
      ScaledFrameModifier(width: width, height: height, alignment: alignment, relativeTo: textStyle)
    )
  }
}
