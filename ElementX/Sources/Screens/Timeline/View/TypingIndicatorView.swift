...
struct TypingIndicatorView: View {
    ...
    var content: some View {
        ...
        case 3...:
            ...
            Text(L10n.tr("Localizable", "screen_room_typing_many_members_first_component_ios", firstMember,
                         lastMember)).bold()
...
struct TypingIndicatorView_Previews: PreviewProvider, TestablePreview {
    static var previews: some View {
        VStack(alignment: .leading, spacing: 16.0) {
            ...
            TypingIndicatorView(typingMembers: TypingMembersObservableObject(members: [
