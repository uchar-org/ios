...
struct SpaceScreenViewModelTests {
    ...
    mutating func multiplePaginations() async throws {
        ...
        // When the pagination is triggered.
        let deferredIsPaginating = deferFulfillment(context.observe(\.viewState.paginationState),
                                                    transitionValues: [.paginating, .idle, .paginating, .endReached])
        let deferredState = deferFulfillment(spaceRoomListProxy.paginationStatePublisher, keyPath: \.self,
                                             transitionValues: [
                                                 .loading,
    ...
    mutating func selectingSpace() async throws {
        ...
        let selectedSpace = try #require(mockSpaceRooms.first { $0.isSpace && $0.state == .joined },
    ...
    mutating func joiningSpace() async throws {
        ...
        let deferredState = deferFulfillment(viewModel.context.observe(\.viewState.joiningRoomIDs),
    ...
    mutating func manageRoomsWithoutRemoving() throws {
        ...
        #expect(!spaceServiceProxy.removeChildFromCalled,
    ...
    mutating func manageRoomsRemovingChildren() async throws {
        ...
        #expect(context.isPresentingRemoveChildrenConfirmation,
        ...
        #expect(spaceServiceProxy.removeChildFromCallsCount == 2,
    ...
    mutating func manageRoomsRemovingChildrenWithFailure() async throws {
        ...
        #expect(context.viewState.editModeSelectedIDs.count == 3,
        ...
        #expect(context.viewState.visibleRooms.count == 2,
                "The removed rooms should no longer be listed for selection.")
        #expect(context.viewState.editModeSelectedIDs.count == 2,
