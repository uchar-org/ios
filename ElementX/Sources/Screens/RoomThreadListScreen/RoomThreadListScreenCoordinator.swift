...
final class RoomThreadListScreenCoordinator: CoordinatorProtocol {
  ...
  private let actionsSubject: PassthroughSubject<RoomThreadListScreenCoordinatorAction, Never> =
    .init()
  ...
  init(parameters: RoomThreadListScreenCoordinatorParameters) {
    ...
    viewModel = RoomThreadListScreenViewModel(
      threadListServiceProxy: parameters.threadListServiceProxy,
