...
struct QRCodeErrorView: View {
  ...
  var title: String {
    ...
    case .slidingSyncNotAvailable:
      L10n.screenQrCodeLoginErrorSlidingSyncNotSupportedTitle(
  ...
  var subtitle: String {
    ...
    case .noCameraPermission:
      L10n.screenQrCodeLoginNoCameraPermissionStateDescription(
    ...
    case .slidingSyncNotAvailable:
      L10n.screenQrCodeLoginErrorSlidingSyncNotSupportedSubtitle(
        InfoPlistReader.main.bundleDisplayName)
    case .deviceAlreadySignedIn:
  ...
  private var buttons: some View {
    VStack(spacing: 16) {
      ...
      case .connectionNotSecure, .unknown, .expired, .declined, .slidingSyncNotAvailable,
        .cancelled:
...
extension QRCodeLoginState.ErrorState {
  fileprivate var previewDisplayName: String {
    switch self {
