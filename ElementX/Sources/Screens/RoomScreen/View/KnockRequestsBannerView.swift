...
private struct MultipleKnockRequestsBannerContent: View {
    ...
    var body: some View {
        VStack(spacing: 14) {
            HStack(spacing: 10) {
                StackedAvatarsView(overlap: 16, lineWidth: 2, avatars: avatars,
...
struct KnockRequestsBannerView_Previews: PreviewProvider, TestablePreview {
    ...
    static var allPreviews: some View {
        KnockRequestsBannerView(requests: singleRequest) { } onAccept: { _ in
        } onViewAll: { }
        ...
        KnockRequestsBannerView(requests: singleRequestWithReason) { } onAccept: { _ in
        } onViewAll: { }
            .previewDisplayName("Single Request with reason")
        KnockRequestsBannerView(requests: singleRequestNoDisplayName) { } onAccept: { _ in
        } onViewAll: { }
            .previewDisplayName("Single Request, No Display Name")
        KnockRequestsBannerView(requests: multipleRequests) { } onAccept: { _ in
        } onViewAll: { }
