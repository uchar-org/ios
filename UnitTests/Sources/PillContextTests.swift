...
struct PillContextTests {
    ...
    func user() async {
        ...
        let context = PillContext(timelineContext: mock.context,
                                  data: PillTextAttachmentData(type: .user(userID: id), font: .preferredFont(forTextStyle: .body)))
        ...
        subject.send([
            RoomMemberProxyMock(with: .init(userID: id, displayName: name, avatarURL: avatarURL, membership: .join))
        ])
        await Task.yield()
    ...
    func allUsers() {
        ...
        let mock = TimelineViewModel(roomProxy: proxyMock,
                                     ...
                                     timelineControllerFactory: TimelineControllerFactoryMock(.init()))
        let context = PillContext(timelineContext: mock.context,
                                  data: PillTextAttachmentData(type: .allUsers, font: .preferredFont(forTextStyle: .body)))
    ...
    func roomIDMention() {
        ...
        let mock = TimelineViewModel(roomProxy: proxyMock,
                                     ...
                                     timelineControllerFactory: TimelineControllerFactoryMock(.init()))
        let context = PillContext(timelineContext: mock.context,
                                  data: PillTextAttachmentData(type: .roomID("1"), font: .preferredFont(forTextStyle: .body)))
    ...
    func roomAliasMention() {
        ...
        let mock = TimelineViewModel(roomProxy: proxyMock,
                                     ...
                                     timelineControllerFactory: TimelineControllerFactoryMock(.init()))
        let context = PillContext(timelineContext: mock.context,
                                  data: PillTextAttachmentData(type: .roomAlias("#foundation-and-empire:matrix.org"),
    ...
    func eventOnRoomIDMention() {
        ...
        let mock = TimelineViewModel(roomProxy: proxyMock,
                                     ...
                                     timelineControllerFactory: TimelineControllerFactoryMock(.init()))
        let context = PillContext(timelineContext: mock.context,
                                  data: PillTextAttachmentData(type: .event(room: .roomID("1")), font: .preferredFont(forTextStyle: .body)))
    ...
    func eventOnRoomAliasMention() {
        ...
        let mock = TimelineViewModel(roomProxy: proxyMock,
                                     ...
                                     timelineControllerFactory: TimelineControllerFactoryMock(.init()))
        let context = PillContext(timelineContext: mock.context,
                                  data: PillTextAttachmentData(type: .event(room: .roomAlias("#foundation-and-empire:matrix.org")),
                                                               font: .preferredFont(forTextStyle: .body)))
