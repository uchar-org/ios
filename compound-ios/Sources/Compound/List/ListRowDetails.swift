...
public struct ListRowDetails<Icon: View> {
  ...
  public static func icon(
    _ icon: KeyPath<CompoundIcons, Image>,
    counter: Int? = nil,
    isWaiting: Bool = false
  ) -> Self where Icon == CompoundIcon {
    ListRowDetails(
...
extension ListRowDetails where Icon == Image {
  ...
  public static func counter(_ counter: Int, isWaiting: Bool = false) -> Self {
    ListRowDetails(counter: counter, isWaiting: isWaiting)
  }

  public static func isWaiting(_ isWaiting: Bool) -> Self {
