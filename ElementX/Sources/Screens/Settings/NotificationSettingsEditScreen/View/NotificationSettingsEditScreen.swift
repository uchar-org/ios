...
struct NotificationSettingsEditScreen_Previews: PreviewProvider, TestablePreview {
  static let viewModelGroupChats: NotificationSettingsEditScreenViewModel = {
    ...
    notificationSettingsProxy.getRoomsWithUserDefinedRulesReturnValue = [RoomSummary].mockRooms.map(
      \.id)
    ...
    var viewModel = NotificationSettingsEditScreenViewModel(
      chatType: .groupChat,
