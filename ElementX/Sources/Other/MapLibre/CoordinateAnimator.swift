...
final class CoordinateAnimator {
  ...
  static func animate(
    ...
    guard
      annotation.coordinate.latitude != end.latitude
        || annotation.coordinate.longitude != end.longitude
    else {
      return
    }
  ...
  @objc private func tick(_ displayLink: CADisplayLink) {
    ...
    let latitude =
      startCoordinate.latitude + (endCoordinate.latitude - startCoordinate.latitude) * easedProgress
    let longitude =
      startCoordinate.longitude + (endCoordinate.longitude - startCoordinate.longitude)
      * easedProgress
