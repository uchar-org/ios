...
struct KnockRequestCell_Previews: PreviewProvider, TestablePreview {
  ...
  static let aliceWithLongReason = KnockRequestCellInfo(
    eventID: "1", userID: "@alice:matrix.org", displayName: "Alice", avatarURL: nil,
  ...
  static let aliceWithNoReason = KnockRequestCellInfo(
    eventID: "1", userID: "@alice:matrix.org", displayName: "Alice", avatarURL: nil,
    timestamp: "20 Nov 2024", reason: nil)

  static let aliceWithNoName = KnockRequestCellInfo(
    eventID: "1", userID: "@alice:matrix.org", displayName: nil, avatarURL: nil,
    timestamp: "20 Nov 2024", reason: nil)
