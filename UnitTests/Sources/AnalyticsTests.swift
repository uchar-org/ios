...
final class AnalyticsTests {
    ...
    func addingUserProperties() {
        ...
        #expect(client.pendingUserProperties?.ftueUseCaseSelection == .PersonalMessaging,
                "The use case selection should match.")
        #expect(client.pendingUserProperties?.numFavouriteRooms == 4,
        ...
        #expect(client.pendingUserProperties?.verificationState
            == AnalyticsEvent.UserProperties.VerificationState.Verified,
            "The verification state should match.")
        #expect(client.pendingUserProperties?.recoveryState
    ...
    func mergingUserProperties() {
        ...
        #expect(client.pendingUserProperties?.ftueUseCaseSelection == .PersonalMessaging,
                "The use case selection should match.")
        #expect(client.pendingUserProperties?.numFavouriteRooms == nil,
    ...
    func sendingUserProperties() throws {
        ...
        #expect(capturedEvent?.userProperties?["ftueUseCaseSelection"] as? String
    ...
    func sendingAndUpdatingSuperProperties() throws {
        ...
        #expect(screenEvent?.properties?["cryptoSDK"] as? String
        ...
        // All the super properties should have been added
        #expect(capturedEvent?.properties?["cryptoSDK"] as? String
            == AnalyticsEvent.SuperProperties.CryptoSDK.Rust.rawValue)
        ...
        #expect(capturedEvent2?.properties?["cryptoSDK"] as? String
            == AnalyticsEvent.SuperProperties.CryptoSDK.Rust.rawValue)
