  ...
  private var disableBackupSection: some View {
    VStack(spacing: 24) {
      ...
      VStack(alignment: .leading, spacing: 4) {
        VisualListItem(
          title: L10n.screenKeyBackupDisableDescriptionPoint1,
          position: .top
        ) {
        ...
        VisualListItem(
          title: L10n.screenKeyBackupDisableDescriptionPoint2(
            InfoPlistReader.main.productionAppName),
          position: .bottom
        ) {
          CompoundIcon(\.close, size: .small, relativeTo: .body)
            .foregroundColor(.compound.iconCriticalPrimary)
...
struct SecureBackupKeyBackupScreen_Previews: PreviewProvider, TestablePreview {
  ...
  static func viewModel(keyBackupState: SecureBackupKeyBackupState)
    -> SecureBackupKeyBackupScreenViewModelType
  {
    ...
    return SecureBackupKeyBackupScreenViewModel(
