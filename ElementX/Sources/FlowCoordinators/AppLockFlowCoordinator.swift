...
class AppLockFlowCoordinator: CoordinatorProtocol {
  ...
  private func showPlaceholder() {
    navigationCoordinator.setRootCoordinator(
      PlaceholderScreenCoordinator(
        hideBrandChrome: appSettings.hideBrandChrome, hideGradientBackground: false),
      animated: false)
...
extension AppLockServiceBiometricResult {
  fileprivate func toStateMachineState() -> AppLockFlowCoordinator.State {
    switch self {
