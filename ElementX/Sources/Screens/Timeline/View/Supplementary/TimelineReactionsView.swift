...
struct TimelineReactionsView: View {
  ...
  init(
    context: TimelineViewModel.Context,
...
struct TimelineCollapseButtonLabel: View {
  ...
  var body: some View {
    TimelineReactionButtonLabel {
      Text(
        collapsed
          ? L10n.screenRoomTimelineReactionsShowMore : L10n.screenRoomTimelineReactionsShowLess
      )
  ...
  private var accessibilityLabel: String {
    if reaction.isHighlighted {
      return reaction.count > 1
        ? L10n.tr(
          "Localizable", "screen_room_timeline_reaction_including_you_a11y", reaction.count - 1,
          reaction.displayKey) : L10n.screenRoomTimelineReactionYouA11y(reaction.displayKey)
    }
    return L10n.tr(
      "Localizable", "screen_room_timeline_reaction_a11y", reaction.count, reaction.displayKey)
  }

  private var toggleReactionAccessibilityActionName: String {
    reaction.isHighlighted
      ? L10n.a11yRemoveReaction(reaction.displayKey) : L10n.a11yAddReaction(reaction.displayKey)
  }
  ...
  var body: some View {
    VStack(spacing: 8) {
      TimelineReactionsView(
        context: TimelineViewModel.mock.context,
        itemID: .randomEvent,
        reactions: [
