...
struct RestorationTokenTests {
    ...
    func decodeFromTokenV4() throws {
        ...
        #expect(decodedToken.pusherNotificationClientIdentifier
        ...
        #expect(decodedToken.sessionDirectories.cacheDirectory
    ...
    func assertEqual(session: Session, originalSession: SessionV1) {
        ...
        #expect(session.refreshToken == originalSession.refreshToken,
        ...
        #expect(session.homeserverUrl == originalSession.homeserverUrl,
