...
struct KnockRequestsListScreen_Previews: PreviewProvider, TestablePreview {
  ...
  static let singleRequestViewModel = KnockRequestsListScreenViewModel.mockWithRequestsState(
    .loaded([
  ...
  static let viewModel = KnockRequestsListScreenViewModel.mockWithRequestsState(
    .loaded([
      KnockRequestProxyMock(
        .init(
          eventID: "1",
      ...
      KnockRequestProxyMock(
        .init(
          ...
          reason:
            "Hello this one is a very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very long reason"
        )),
      KnockRequestProxyMock(
        .init(
          eventID: "3",
  ...
  static var previews: some View {
    ...
    .snapshotPreferences(
      expect: singleRequestViewModel.context.$viewState.map { state in
        state.shouldDisplayRequests == true
      }
    )
    ...
    .snapshotPreferences(
      expect: emptyViewModel.context.$viewState.map { state in
    ...
    .snapshotPreferences(
      expect: loadingViewModel.context.$viewState.map { state in
...
extension KnockRequestsListScreenViewModel {
  static func mockWithRequestsState(_ requestsState: KnockRequestsState)
