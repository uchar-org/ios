...
struct TimelineStyler<Content: View>: View {
  ...
  var mainContent: some View {
    TimelineItemBubbledStylerView(
      timelineItem: timelineItem, adjustedDeliveryStatus: adjustedDeliveryStatus, content: content)
  }
}
...
struct TimelineItemStyler_Previews: PreviewProvider, TestablePreview {
  ...
  static let base = TextRoomTimelineItem(
    id: .randomEvent,
    timestamp: .mock,
    isOutgoing: true,
    isEditable: false,
  ...
  static let sendingLast: TextRoomTimelineItem = {
    ...
    var result = TextRoomTimelineItem(
      id: .event(uniqueID: id, eventOrTransactionID: .eventID(UUID().uuidString)),
      timestamp: .mock,
      isOutgoing: true,
      isEditable: false,
      canBeRepliedTo: true,
  ...
  static let ltrString = TextRoomTimelineItem(
    id: .randomEvent,
    timestamp: .mock,
    isOutgoing: true,
    isEditable: false,
  ...
  static let ltrStringThatContainsRtl = TextRoomTimelineItem(
    id: .randomEvent,
    timestamp: .mock,
    isOutgoing: true,
    isEditable: false,
  ...
  static let rtlStringThatContainsLtr = TextRoomTimelineItem(
    id: .randomEvent,
    timestamp: .mock,
    isOutgoing: true,
    isEditable: false,
  ...
  static let ltrStringThatFinishesInRtl = TextRoomTimelineItem(
    id: .randomEvent,
    timestamp: .mock,
    isOutgoing: true,
    isEditable: false,
  ...
  static let rtlStringThatFinishesInLtr = TextRoomTimelineItem(
    id: .randomEvent,
    timestamp: .mock,
    isOutgoing: true,
    isEditable: false,
