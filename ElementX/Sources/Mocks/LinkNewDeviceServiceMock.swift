...
extension LinkNewDeviceServiceMock {
  ...
  struct Configuration {
    var linkMobileProgressPublisher: LinkNewDeviceService.LinkMobileProgressPublisher = .init(
      .starting)
    var linkDesktopProgressPublisher: LinkNewDeviceService.LinkDesktopProgressPublisher = .init(
      .starting)
  }
