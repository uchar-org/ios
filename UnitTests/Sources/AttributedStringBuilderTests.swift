...
struct AttributedStringBuilderTests {
    ...
    func renderHTMLStringWithHeaders() throws {
        let attributedString = try #require(attributedStringBuilder.fromHTML(HTMLFixtures.headers.rawValue),
                                            "Could not build the attributed string")

        #expect(String(attributedString.characters)
            == "H1 Header\nH2 Header\nH3 Header\nH4 Header\nH5 Header\nH6 Header")
    ...
    func renderHTMLStringWithPreCode() throws {
        let attributedString = try #require(attributedStringBuilder.fromHTML(HTMLFixtures.code.rawValue),
                                            "Could not build the attributed string")
        ...
        let regex = try #require(try? NSRegularExpression(pattern: "\\R", options: []),
    ...
    func renderHTMLStringWithLink() throws {
        let attributedString = try #require(attributedStringBuilder.fromHTML(HTMLFixtures.links.rawValue),
                                            "Could not build the attributed string")
    ...
    func linkWithFragment() throws {
        ...
        try checkLinkIn(attributedString: attributedStringBuilder.fromHTML(string),
                        expectedLink: "https://example.com", expectedRuns: 1)
        try checkLinkIn(attributedString: attributedStringBuilder.fromPlain(string),
                        expectedLink: "https://example.com", expectedRuns: 1)
    ...
    func permalink() throws {
        ...
        try checkLinkIn(attributedString: attributedStringBuilder.fromHTML(string), expectedLink: string,
                        expectedRuns: 1)
        try checkLinkIn(attributedString: attributedStringBuilder.fromPlain(string), expectedLink: string,
                        expectedRuns: 1)
    }
    ...
    func userIDLink() throws {
        ...
        try checkLinkIn(attributedString: attributedStringBuilder.fromHTML(string), expectedLink: expectedLink,
                        expectedRuns: 3)
        try checkLinkIn(attributedString: attributedStringBuilder.fromPlain(string), expectedLink: expectedLink,
                        expectedRuns: 3)
    }
    ...
    func blockquoteWithLink() throws {
        ...
        #expect(coalescedComponents.first?.attributedString.runs.count == 3,
    ...
    func multipleGroupedBlockquotes() throws {
        let attributedString = try #require(attributedStringBuilder.fromHTML(HTMLFixtures.groupedBlockQuotes.rawValue),
                                            "Could not build the attributed string")
    ...
    func multipleSeparatedBlockquotes() throws {
        let attributedString = try #require(attributedStringBuilder.fromHTML(HTMLFixtures.separatedBlockQuotes.rawValue),
                                            "Could not build the attributed string")
    ...
    func eventRoomIDPermalinkMentionAttachment() {
        ...
        let attributedStringFromHTML = attributedStringBuilder.fromHTML(string)
        #expect(attributedStringFromHTML?.attachment != nil)
        #expect(attributedStringFromHTML?.eventOnRoomID
            == .some(.init(roomID: "!test:matrix.org", eventID: "$test")))
        #expect(attributedStringFromHTML?.link?.absoluteString == string)
        let attributedStringFromPlain = attributedStringBuilder.fromPlain(string)
        #expect(attributedStringFromPlain?.attachment != nil)
        #expect(attributedStringFromPlain?.eventOnRoomID
            == .some(.init(roomID: "!test:matrix.org", eventID: "$test")))
        #expect(attributedStringFromPlain?.link?.absoluteString == string)
    }
    ...
    func eventRoomAliasPermalinkMentionAttachment() {
        ...
        let attributedStringFromHTML = attributedStringBuilder.fromHTML(string)
        #expect(attributedStringFromHTML?.attachment != nil)
        #expect(attributedStringFromHTML?.eventOnRoomAlias
            == .some(.init(alias: "#test:matrix.org", eventID: "$test")))
        #expect(attributedStringFromHTML?.link?.absoluteString
            == "https://matrix.to/#/%23test:matrix.org/$test")
        let attributedStringFromPlain = attributedStringBuilder.fromPlain(string)
        #expect(attributedStringFromPlain?.attachment != nil)
        #expect(attributedStringFromPlain?.eventOnRoomAlias
            == .some(.init(alias: "#test:matrix.org", eventID: "$test")))
        #expect(attributedStringFromPlain?.link?.absoluteString
            == "https://matrix.to/#/%23test:matrix.org/$test")
    }
    ...
    func phishingUserIDWithAnotherUserIDPermalink() throws {
        ...
        let link = try #require(attributedString.runs.first { $0.link != nil }?.link, "Couldn't find the link")
        #expect(link.requiresConfirmation)
        #expect(link.confirmationParameters?.internalURL.absoluteString
    ...
    func mxExternalPaymentDetailsRemoved() throws {
        ...
        #expect(String(attributedString2.characters)
