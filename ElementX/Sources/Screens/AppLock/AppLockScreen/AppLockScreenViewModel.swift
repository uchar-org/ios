...
typealias AppLockScreenViewModelType = StateStoreViewModel<
  AppLockScreenViewState, AppLockScreenViewAction
>
...
class AppLockScreenViewModel: AppLockScreenViewModelType, AppLockScreenViewModelProtocol {
  ...
  private func forceLogout() {
    state.forcedLogoutIndicator = UserIndicator(
      type: .modal, title: L10n.commonSigningOut, persistent: true)
