...
enum PinnedEventsBannerState: Equatable {
  ...
  var bannerIndicatorDescription: AttributedString {
    ...
    var finalString = AttributedString(
      L10n.screenRoomPinnedBannerIndicatorDescription(boldPlaceholder))
  ...
  mutating func setPinnedEventContents(
    _ pinnedEventContents: OrderedDictionary<String, AttributedString>
  ) {
    switch self {
    case .loading:
      ...
      self = .loaded(
        state: .init(
          pinnedEventContents: pinnedEventContents,
