...
struct LinkNewDeviceScreen_Previews: PreviewProvider, TestablePreview {
    ...
    static var previews: some View {
        ...
        .snapshotPreferences(expect: viewModel.context.observe(\.viewState.mode).map {
        ...
        .snapshotPreferences(expect: generatingViewModel.context.observe(\.viewState.mode).map {
        ...
        .snapshotPreferences(expect: unsupportedViewModel.context.observe(\.viewState.mode).map {
