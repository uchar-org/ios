...
struct LocationMarkerView: View {
  ...
  var body: some View {
    ...
    Canvas { context, canvasSize in
      ...
      let dotPath = Path(
        ellipseIn: CGRect(
          x: (circleCenter.x - circleRadius) * scaleX,
