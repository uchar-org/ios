...
protocol MentionBuilderProtocol {
    ...
    func handleEventOnRoomAliasMention(for attributedString: NSMutableAttributedString, in range: NSRange, url: URL, eventID: String,
                                       roomAlias: String)
    func handleEventOnRoomIDMention(for attributedString: NSMutableAttributedString, in range: NSRange, url: URL, eventID: String,
                                    roomID: String)
...
struct AttributedStringBuilder: AttributedStringBuilderProtocol {
    ...
    func fromHTML(_ htmlString: String?) -> AttributedString? {
        ...
        var listIndex = 1
        let mutableAttributedString = attributedString(element: body, documentBody: body, preserveFormatting: false, listTag: nil,
    ...
    func attributedString(element: Element,
        ...
        for node in element.getChildNodes() {
            ...
            case "h1", "h2", "h3", "h4", "h5", "h6":
                ...
                content = attributedString(element: childElement, documentBody: documentBody, preserveFormatting: preserveFormatting,
            ...
            case "u":
                content = attributedString(element: childElement, documentBody: documentBody, preserveFormatting: preserveFormatting,
                                           listTag: listTag, listIndex: &childIndex, indentLevel: indentLevel)
                content.addAttribute(.underlineStyle, value: NSUnderlineStyle.single.rawValue,
            ...
            case "code", "pre":
                ...
                if isCodeBlock {
                    ...
                    content.addAttribute(.backgroundColor, value: UIColor.compound._bgCodeBlock as Any,
                                         range: NSRange(location: 0, length: content.length))
                }
            ...
            case "span":
                if childElement.dataset()[Self.attributeMSC4286] == nil {
                    content = attributedString(element: childElement, documentBody: documentBody,
    ...
    private func addLinksAndMentions(_ attributedString: NSMutableAttributedString) {
        ...
        matches.append(contentsOf: MatrixEntityRegex.allUsersRegex.matches(in: attributedString.string).map {
            match in
