...
class ReportContentScreenViewModel: ReportContentScreenViewModelType,
    ...
    init(eventID: String, senderID: String, roomProxy: JoinedRoomProxyProtocol,
    ...
    private func submitReport() async {
        ...
        if case .failure(let error) = await roomProxy.reportContent(eventID, reason: state.bindings.reasonText) {
