...
final class SpaceSettingsFlowCoordinator: FlowCoordinatorProtocol {
  ...
  private let actionsSubject: PassthroughSubject<SpaceSettingsFlowCoordinatorAction, Never> =
    .init()
  ...
  init(
    ...
    initialCoordinator =
      navigationStackCoordinator.stackCoordinators.last
      ?? navigationStackCoordinator.rootCoordinator
  ...
  private func configureStateMachine() {
    ...
    stateMachine.addAnyHandler(.any => .any) { [weak self] context in
      ...
      case (
        .manageAuthorizedSpacesScreen, .dismissedManageAuthorizedSpacesScreen, .securityAndPrivacy
      ):
        break
  ...
  private func presentSpaceSettings(animated: Bool) {
    let coordinator = RoomDetailsScreenCoordinator(
      parameters: .init(
        roomProxy: roomProxy,
    ...
    coordinator.actions.sink { [weak self] action in
      ...
      case .presentRecipientDetails, .presentNotificationSettingsScreen, .presentReportRoomScreen,
        ...
        .presentKnockingRequestsListScreen:
  ...
  private func presentEditDetailsScreen() {
    ...
    let parameters = RoomDetailsEditScreenCoordinatorParameters(
      roomProxy: roomProxy,
      userSession: flowParameters.userSession,
