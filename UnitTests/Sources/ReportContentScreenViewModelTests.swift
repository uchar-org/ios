...
struct ReportContentScreenViewModelTests {
    ...
    func reportContent() async throws {
        ...
        #expect(roomProxy.reportContentReasonReceivedArguments?.eventID == eventID,
                "The event ID should match the content being reported.")
        #expect(roomProxy.reportContentReasonReceivedArguments?.reason == reportReason,
    ...
    func reportIgnoringSender() async throws {
        ...
        #expect(clientProxy.ignoreUserReceivedUserID == senderID,
