...
extension View {
  ...
  public func scaledPadding(_ length: CGFloat, relativeTo textStyle: Font.TextStyle = .body)
    -> some View
  {
  ...
  public func scaledPadding(
    _ edges: Edge.Set, _ length: CGFloat, relativeTo textStyle: Font.TextStyle = .body
  ) -> some View {
