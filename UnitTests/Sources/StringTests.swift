...
struct StringTests {
  ...
  func generateBreakableWhitespaceEnd() {
    ...
    #expect(
      String.generateBreakableWhitespaceEnd(whitespaceCount: count, layoutDirection: .leftToRight)
        == result)
    ...
    #expect(
      String.generateBreakableWhitespaceEnd(whitespaceCount: count, layoutDirection: .rightToLeft)
        == result)
