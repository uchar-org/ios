...
struct MediaEventsTimelineScreen: View {
  ...
  private func viewForTimelineItem(_ item: RoomTimelineItemViewState) -> some View {
    ...
    case .voice(let timelineItem):
      let defaultPlayerState = AudioPlayerState(
        id: .timelineItemIdentifier(timelineItem.id), title: L10n.commonVoiceMessage, duration: 0)
      let playerState =
...
struct MediaEventsTimelineScreen_Previews: PreviewProvider, TestablePreview {
  ...
  private static func makeViewModel(
    empty: Bool = false,
    screenMode: MediaEventsTimelineScreenMode
  ) -> MediaEventsTimelineScreenViewModel {
    MediaEventsTimelineScreenViewModel(
      mediaTimelineViewModel: makeTimelineViewModel(empty: empty),
  ...
  private static func makeTimelineViewModel(empty: Bool) -> TimelineViewModel {
    ...
    return TimelineViewModel(
      roomProxy: JoinedRoomProxyMock(.init(name: "Preview room")),
