...
struct ReportContentScreenViewModelTests {
  ...
  func reportContent() async throws {
    ...
    let viewModel = ReportContentScreenViewModel(
      eventID: eventID,
      senderID: senderID,
      roomProxy: roomProxy,
    ...
    #expect(
      roomProxy.reportContentReasonReceivedArguments?.eventID == eventID,
      "The event ID should match the content being reported.")
    #expect(
      roomProxy.reportContentReasonReceivedArguments?.reason == reportReason,
      "The reason should match the user input.")
    #expect(
      clientProxy.ignoreUserCallsCount == 0, "A call to ignore a user should not have been made.")
  ...
  func reportIgnoringSender() async throws {
    ...
    #expect(
      ...
      "The reason should match the user input.")
    #expect(
      clientProxy.ignoreUserCallsCount == 1, "A call should have been made to ignore the sender.")
    #expect(
      clientProxy.ignoreUserReceivedUserID == senderID,
      "The ignored user ID should match the sender.")
  }
}
