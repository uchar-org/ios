    ...
    Form {
      Section {
        EditRoomAddressListRow(
          aliasLocalPart: $context.desiredAliasLocalPart,
...
struct EditRoomAddressScreen_Previews: PreviewProvider, TestablePreview {
  static let noAliasviewModel = EditRoomAddressScreenViewModel(
    roomProxy: JoinedRoomProxyMock(.init(name: "Room Name")),
    clientProxy: ClientProxyMock(.init(userIDServerName: "matrix.org")),
    userIndicatorController: UserIndicatorControllerMock())

  static let aliasviewModel = EditRoomAddressScreenViewModel(
    roomProxy: JoinedRoomProxyMock(
      .init(name: "Room Name", canonicalAlias: "#room-alias:matrix.org")),
    clientProxy: ClientProxyMock(.init(userIDServerName: "matrix.org")),
    userIndicatorController: UserIndicatorControllerMock())

  static let invalidSymbolsViewModel = EditRoomAddressScreenViewModel(
    roomProxy: JoinedRoomProxyMock(
      .init(name: "Room Name", canonicalAlias: "#room#-alias:matrix.org")),
    clientProxy: ClientProxyMock(.init(userIDServerName: "matrix.org")),
    userIndicatorController: UserIndicatorControllerMock())
  ...
  static let alreadyExistingViewModel = {
    ...
    return EditRoomAddressScreenViewModel(
  ...
  static var previews: some View {
    ...
    .snapshotPreferences(
      expect: invalidSymbolsViewModel.context.$viewState.map { state in
    ...
    .snapshotPreferences(
      expect: alreadyExistingViewModel.context.$viewState.map { state in
        !state.aliasErrors.isEmpty
      }
    )
