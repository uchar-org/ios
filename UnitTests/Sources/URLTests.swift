...
struct URLTests {
    ...
    func complexURLDirectoryName() throws {
        let url: URL =
            "https://us%3Aer:pa%40%3Ass@[2001:db8:85a3::8a2e:370:7334]:8443/..//folder/./fi%20le(1).html;p=1;q=2"
        let directoryName = url.asDirectoryName()
        #expect(directoryName
            == "us%3Aer-pa%40%3Ass@[2001-db8-85a3--8a2e-370-7334]-8443-..--folder-.-fi%20le(1).html;p=1;q=2")
        try createDirectory(with: directoryName)
    }
