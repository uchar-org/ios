...
struct SettingsScreen: View {
  ...
  var body: some View {
    ...
    .toolbarVisibility(
      ProcessInfo.processInfo.isiOSAppOnMac ? .hidden : .automatic, for: .navigationBar)
    //        .toolbar { toolbar }
  }
  ...
  private var manageMyAppSection: some View {
    Section {
      ListRow(
        label: .default(
          title: L10n.screenNotificationSettingsTitle,
          icon: \.notifications),
        kind: .navigationLink {
  ...
  private var manageAccountSection: some View {
    Section {
      if let url = context.viewState.accountProfileURL {
        ListRow(
          label: .default(
            title: L10n.actionManageAccountAndDevices,
            icon: \.userProfile),
          kind: .button {
      ...
      if context.viewState.showLinkNewDeviceButton {
        ListRow(
          label: .default(
            title: L10n.commonLinkNewDevice,
            icon: \.devices),
          kind: .navigationLink {
  ...
  private var generalSection: some View {
    Section {
      ListRow(
        label: .default(
          title: L10n.commonAdvancedSettings,
          icon: \.settings),
        kind: .navigationLink {
      ...
      ListRow(
        label: .default(
          title: L10n.screenAdvancedSettingsLabs,
          icon: \.labs),
        kind: .navigationLink {
      ...
      if context.viewState.isBugReportServiceEnabled {
        ListRow(
          label: .default(
            title: L10n.commonReportAProblem,
            icon: \.chatProblem),
          kind: .navigationLink {
  ...
  private var signOutSection: some View {
    Section {
      ListRow(
        label: .action(
          title: L10n.screenSignoutPreferenceItem,
          icon: \.close,
          role: .destructive),
        kind: .button {
      ...
      if context.viewState.showAccountDeactivation {
        ListRow(
          label: .action(
            title: L10n.actionDeleteAccount,
            icon: \.delete,
            role: .destructive),
          kind: .navigationLink {
  ...
  private var developerOptionsSection: some View {
    Section {
      ListRow(
        label: .default(
          title: L10n.commonDeveloperOptions,
          icon: \.code),
        kind: .navigationLink {
...
struct SettingsScreen_Previews: PreviewProvider, TestablePreview {
  ...
  static var previews: some View {
    ...
    .snapshotPreferences(
      expect: viewModel.context.observe(\.viewState.accountProfileURL).map { $0 != nil }
    )
    ...
    .snapshotPreferences(
      expect: bugReportDisabledViewModel.context.observe(\.viewState.accountProfileURL).map {
        $0 != nil
      }
    )
