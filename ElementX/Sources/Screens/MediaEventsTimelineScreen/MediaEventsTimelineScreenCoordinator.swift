...
final class MediaEventsTimelineScreenCoordinator: CoordinatorProtocol {
  ...
  private let actionsSubject:
    PassthroughSubject<MediaEventsTimelineScreenCoordinatorAction, Never> = .init()
  ...
  init(parameters: MediaEventsTimelineScreenCoordinatorParameters) {
    ...
    let mediaTimelineViewModel = TimelineViewModel(
    ...
    let filesTimelineViewModel = TimelineViewModel(
      roomProxy: parameters.roomProxy,
    ...
    viewModel = MediaEventsTimelineScreenViewModel(
