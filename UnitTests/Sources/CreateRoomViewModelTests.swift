...
final class CreateRoomScreenViewModelTests {
    ...
    func createRoomInAnAlreadySelectedSpace() async throws {
        ...
        #expect(context.viewState.availableAccessTypes == [
    ...
    private func setup(isSpace: Bool = false,
                       spacesSelectionMode: CreateRoomScreenSpaceSelectionMode = .editableSpacesList(preSelectedSpace: nil)) {
