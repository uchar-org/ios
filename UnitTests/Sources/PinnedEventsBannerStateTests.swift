...
struct PinnedEventsBannerStateTests {
    ...
    func loading() {
        ...
        #expect(state.bannerIndicatorDescription.string
            == L10n.screenRoomPinnedBannerIndicatorDescription(L10n.screenRoomPinnedBannerIndicator(5, 5)))
    }
    ...
    func loadingToLoaded() {
        ...
        #expect(state
            == .loaded(state: .init(pinnedEventContents: ["1": "test1", "2": "test2"], selectedPinnedEventID: "2")))
        #expect(!state.isLoading)
    }
    ...
    func loaded() {
        ...
        #expect(state.bannerIndicatorDescription.string
            == L10n.screenRoomPinnedBannerIndicatorDescription(L10n.screenRoomPinnedBannerIndicator(2, 2)))
    }
    ...
    @Test
    func setContent() {
        var state = PinnedEventsBannerState.loaded(state: .init(pinnedEventContents: ["1": "test1", "2": "test2", "3": "test3", "4": "test4"],
