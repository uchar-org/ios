...
typealias ManageRoomMemberSheetViewModelType = StateStoreViewModelV2<
  ManageRoomMemberSheetViewState, ManageRoomMemberSheetViewAction
>

class ManageRoomMemberSheetViewModel: ManageRoomMemberSheetViewModelType,
  ManageRoomMemberSheetViewModelProtocol
{
  private let roomProxy: JoinedRoomProxyProtocol
  private let userIndicatorController: UserIndicatorControllerProtocol
  private let analyticsService: AnalyticsService

  private var actionsSubject: PassthroughSubject<ManageRoomMemberSheetViewModelAction, Never> =
    .init()
  ...
  init(
    memberDetails: ManageRoomMemberDetails,
    ...
    super.init(
      initialViewState: .init(memberDetails: memberDetails, permissions: permissions),
  ...
  private func displayAlert(_ alertType: ManageRoomMemberSheetViewAlertType) {
    ...
    case .kick:
      state.bindings.alertInfo = .init(
        ...
        message: roomProxy.infoPublisher.value.isSpace
          ? L10n.screenBottomSheetManageRoomMemberKickMemberFromSpaceConfirmationDescription
          : L10n.screenBottomSheetManageRoomMemberKickMemberConfirmationDescription,
        primaryButton: .init(title: L10n.actionCancel, role: .cancel) {},
        secondaryButton: .init(
          title: L10n.screenBottomSheetManageRoomMemberKickMemberConfirmationAction
        ) { [weak self] in
          Task { await self?.kickMember(id: memberID, name: memberName, reason: reason) }
        },
        textFields: [
          .init(
            placeholder: L10n.commonReason,
            text: binding,
    ...
    case .ban:
      state.bindings.alertInfo = .init(
        ...
        message: roomProxy.infoPublisher.value.isSpace
          ? L10n.screenBottomSheetManageRoomMemberBanMemberFromSpaceConfirmationDescription
          : L10n.screenBottomSheetManageRoomMemberBanMemberConfirmationDescription,
        primaryButton: .init(title: L10n.actionCancel, role: .cancel) {},
        secondaryButton: .init(
          title: L10n.screenBottomSheetManageRoomMemberBanMemberConfirmationAction
        ) { [weak self] in
          Task { await self?.banMember(id: memberID, name: memberName, reason: reason) }
        },
        textFields: [
          .init(
            placeholder: L10n.commonReason,
    ...
    case .unban:
      state.bindings.alertInfo = .init(
        ...
        primaryButton: .init(title: L10n.actionCancel, role: .cancel) {},
        secondaryButton: .init(
          title: L10n.screenBottomSheetManageRoomMemberUnbanMemberConfirmationAction
        ) { [weak self] in Task { await self?.unbanMember(id: memberID, name: memberName) } })
    }
  }
  ...
  private func showManageMemberFailure(title: String) {
    userIndicatorController.retractIndicatorWithId(title)
    userIndicatorController.submitIndicator(
      UserIndicator(title: L10n.commonFailed, iconName: "xmark"))
  }
}
