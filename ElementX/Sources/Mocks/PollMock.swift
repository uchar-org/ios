...
extension Poll {
  static func mock(
    ...
    votes: [String: [String]] = [:],
    ended: Bool = false,
    createdByAccountOwner: Bool = false
  ) -> Self {
    .init(
      question: question,
      kind: pollKind,
  ...
  static func disclosed(createdByAccountOwner: Bool = false) -> Self {
    mock(
      question: "What country do you like most?",
      pollKind: .disclosed,
      options: [
        .mock(text: "Italy 🇮🇹", votes: 5, allVotes: 10, isWinning: true),
  ...
  static var emptyDisclosed: Self {
    mock(
      ...
      pollKind: .disclosed,
      options: [
        .mock(text: "Italy 🇮🇹", votes: 0, allVotes: 0),
...
extension Poll.Option {
  static func mock(
    text: String, votes: Int = 0, allVotes: Int = 0, isSelected: Bool = false,
