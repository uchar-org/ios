...
typealias EncryptionResetScreenViewModelType = StateStoreViewModelV2<
  EncryptionResetScreenViewState, EncryptionResetScreenViewAction
>
  ...
  override func process(viewAction: EncryptionResetScreenViewAction) {
    ...
    case .reset:
      state.bindings.alertInfo = .init(
        ...
        primaryButton: .init(
          title: L10n.screenResetEncryptionConfirmationAlertAction, role: .destructive
        ) { [weak self] in
