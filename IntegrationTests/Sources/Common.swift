...
extension XCUIApplication {
  ...
  func login(currentTestCase: XCTestCase) throws {
    ...
    let webLogoutPredicate = NSPredicate(
      format: "label == 'Sign out' OR label == 'Use another account'")
  ...
  func logout() {
    ...
    let alertLogoutButton = alerts.firstMatch.buttons[A11yIdentifiers.alertInfo.primaryButton]
      .firstMatch
