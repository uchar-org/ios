  ...
  static var previews: some View {
    ...
    PillView(
      context: PillContext.mock(
        viewState: .mention(
          isOwnMention: false,
          displayText: PillUtilities.userPillDisplayText(
            username: "Alice but with a very long name",
            userID: "@alice:matrix.org")))
    ) {}
    .frame(maxWidth: PillUtilities.mockMaxWidth)
    ...
    PillView(
      context: PillContext.mock(
        viewState: .mention(
          isOwnMention: true,
          displayText: PillUtilities.userPillDisplayText(
            username: "Alice", userID: "@alice:matrix.org")))
    ) {}
    .frame(maxWidth: PillUtilities.mockMaxWidth)
      ...
      context: PillContext.mock(
        viewState: .reference(
          displayText: PillUtilities.eventPillDisplayText(
            roomName: "Room", rawRoomText: "#room:matrix.org")))
    ) {}
    .frame(maxWidth: PillUtilities.mockMaxWidth)
    ...
    PillView(
      context: PillContext.mock(
        viewState: .reference(
          displayText: PillUtilities.eventPillDisplayText(
            roomName: nil, rawRoomText: "#room:matrix.org")))
    ) {}
    .frame(maxWidth: PillUtilities.mockMaxWidth)
