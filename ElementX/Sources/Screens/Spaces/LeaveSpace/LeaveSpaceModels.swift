...
struct LeaveSpaceViewState: BindableState {
  ...
  var title: String {
    ...
    case .spaceNeedsNewOwner(let useTransferOwnershipFlow):
      useTransferOwnershipFlow
        ? L10n.leaveRoomAlertSelectNewOwnerTitle : L10n.screenLeaveSpaceTitleLastAdmin(spaceName)
  ...
  var subtitle: String? {
    ...
    case .spaceNeedsNewOwner(let useTransferOwnershipFlow):
      useTransferOwnershipFlow
        ? L10n.screenLeaveSpaceSubtitleLastOwner(spaceName) : L10n.screenLeaveSpaceSubtitleLastAdmin
    }
  }
