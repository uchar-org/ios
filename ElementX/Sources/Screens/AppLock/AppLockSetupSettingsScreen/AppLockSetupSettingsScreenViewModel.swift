...
typealias AppLockSetupSettingsScreenViewModelType = StateStoreViewModel<
  AppLockSetupSettingsScreenViewState, AppLockSetupSettingsScreenViewAction
>

class AppLockSetupSettingsScreenViewModel: AppLockSetupSettingsScreenViewModelType,
  AppLockSetupSettingsScreenViewModelProtocol
{
  private let appLockService: AppLockServiceProtocol
  private var actionsSubject: PassthroughSubject<AppLockSetupSettingsScreenViewModelAction, Never> =
    .init()
  ...
  init(appLockService: AppLockServiceProtocol) {
    ...
    super.init(
      initialViewState: AppLockSetupSettingsScreenViewState(
