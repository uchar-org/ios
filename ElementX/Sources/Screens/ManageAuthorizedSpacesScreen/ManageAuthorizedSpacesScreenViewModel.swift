...
typealias ManageAuthorizedSpacesScreenViewModelType = StateStoreViewModelV2<
  ManageAuthorizedSpacesScreenViewState, ManageAuthorizedSpacesScreenViewAction
>

class ManageAuthorizedSpacesScreenViewModel: ManageAuthorizedSpacesScreenViewModelType,
  ManageAuthorizedSpacesScreenViewModelProtocol
{
  private let actionsSubject:
    PassthroughSubject<ManageAuthorizedSpacesScreenViewModelAction, Never> = .init()
  var actionsPublisher: AnyPublisher<ManageAuthorizedSpacesScreenViewModelAction, Never> {
    actionsSubject.eraseToAnyPublisher()
  }

  init(
    authorizedSpacesSelection: AuthorizedSpacesSelection,
    mediaProvider: MediaProviderProtocol
  ) {
    super.init(
      initialViewState: ManageAuthorizedSpacesScreenViewState(
        authorizedSpacesSelection: authorizedSpacesSelection),
