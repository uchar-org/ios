...
struct VisualListItem<Icon: View>: View {
    ...
    var body: some View {
        ...
        .background(.compound.bgSubtleSecondary,
                    in: RoundedCornerShape(radius: 14, corners: position.roundedCorners))
    }
}
...
struct VisualListItem_Previews: PreviewProvider, TestablePreview {
    static let strings = AnalyticsPromptScreenStrings(termsURL: AppSettings().analyticsTermsURL)
    ...
    static var previews: some View {
        VStack(alignment: .leading, spacing: 4) {
            ...
            VisualListItem(title:
                "This is a very long string that will be used to test the layout over multiple lines of text to ensure everything is correct.",
                position: .bottom) {
                    testImage2
                }
        }
