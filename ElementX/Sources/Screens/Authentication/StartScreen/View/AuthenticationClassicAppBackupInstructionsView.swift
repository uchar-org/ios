...
struct AuthenticationClassicAppBackupInstructionsView: View {
  ...
  private var buttonTitle: String {
    isRefreshingSecrets
      ? L10n.screenOnboardingCheckingAccount : L10n.screenMissingKeyBackupOpenElementClassic
  }
  ...
  var content: some View {
    VStack(alignment: .leading, spacing: 40) {
      TitleAndIcon(
        title: L10n.screenMissingKeyBackupTitle(InfoPlistReader.main.bundleDisplayName),
        icon: \.keySolid,
        iconStyle: .default
      )
