...
extension View {
  ...
  func timelineItemSendInfo(
    timelineItem: EventBasedTimelineItemProtocol,
    adjustedDeliveryStatus: TimelineItemDeliveryStatus?,
    context: TimelineViewModel.Context
  ) -> some View {
    modifier(
      TimelineItemSendInfoModifier(
        sendInfo: .init(
...
extension TimelineItemSendInfo {
  fileprivate init(
    timelineItem: EventBasedTimelineItemProtocol,
    adjustedDeliveryStatus: TimelineItemDeliveryStatus?
  ) {
    ...
    status =
      if case .sendingFailed = adjustedDeliveryStatus {
        .sendingFailed
...
extension LiveLocationRoomTimelineItem {
  fileprivate var layout: TimelineItemSendInfo.LayoutType {
