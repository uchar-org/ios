...
struct AuthenticationServiceTests {
  ...
  mutating func passwordLogin() async throws {
    ...
    switch await service.login(
      username: "alice", password: "12345678", initialDeviceName: nil, deviceID: nil)
    {
    case .success:
      ...
      #expect(
        userSessionStore.userSessionForSessionDirectoriesPassphraseReceivedArguments?.passphrase
  ...
  private mutating func setup(
    serverAddress: String = "matrix.org",
