...
typealias ThreadTimelineScreenViewModelType = StateStoreViewModel<
  ThreadTimelineScreenViewState, ThreadTimelineScreenViewAction
>
  ...
  ThreadTimelineScreenViewModelProtocol
{
  ...
  init(
    ...
    super.init(
      initialViewState: ThreadTimelineScreenViewState(
