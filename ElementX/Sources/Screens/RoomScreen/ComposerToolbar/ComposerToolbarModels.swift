...
enum ComposerToolbarViewModelAction {
  case sendMessage(
    plain: String, html: String?, mode: ComposerMode, intentionalMentions: IntentionalMentions)
...
enum ComposerMode: Equatable {
  ...
  case edit(
    originalEventOrTransactionID: TimelineItemIdentifier.EventOrTransactionID, type: EditType)
