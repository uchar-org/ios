...
struct RoomEventStringBuilderTests {
    ...
    func senderPrefix() {
        ...
        #expect(ownMessageString?.string == "You: Hello, World!",
        ...
        #expect(otherMessageString?.string == "Bob: Hello, World!",
        ...
        let otherEmoteString = stringBuilder.buildAttributedString(for: makeMessageItem(senderID: "@bob:matrix.org",
                                                                                        ...
                                                                                        type: .emote,
                                                                                        message: "sighs"))
        #expect(otherEmoteString?.string == "* Bob sighs",
        ...
        #expect(ownPollString?.string == "You: Poll: Which is better?",
        ...
        #expect(otherPollString?.string == "Bob: Poll: Which is better?",
    ...
    private func makeMessageItem(senderID: String,
        ...
        return .init(item: .init(configuration: .init(eventID: "1234",
                                                      sender: senderID,
                                                      senderProfile: .ready(displayName: senderDisplayName, displayNameAmbiguous: senderDisplayNameAmbiguous,
                                                                            avatarUrl: nil),
