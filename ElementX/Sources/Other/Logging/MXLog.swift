...
enum MXLog {
    ...
    static func dev(_ message: Any,
                    ...
                    line: Int = #line,
                    column: Int = #column) {
        log("[\(devPrefix)] \(message)", level: .info, file: file, function: function, line: line,
            column: column)
    }
    #endif
    ...
    private static func log(_ message: Any,
        ...
        logEvent(file: (file as NSString).lastPathComponent, line: UInt32(line), level: level.rustLogLevel,
