...
typealias SessionVerificationViewModelType = StateStoreViewModel<
  SessionVerificationScreenViewState, SessionVerificationScreenViewAction
>

class SessionVerificationScreenViewModel: SessionVerificationViewModelType,
  SessionVerificationScreenViewModelProtocol
{
  ...
  private var actionsSubject: PassthroughSubject<SessionVerificationScreenViewModelAction, Never> =
    .init()
  ...
  init(
    sessionVerificationControllerProxy: SessionVerificationControllerProxyProtocol,
    ...
    case .deviceResponder(let details), .userResponder(let details):
      Task {
        await self.sessionVerificationControllerProxy.acknowledgeVerificationRequest(
          details: details)
      }
    default:
      break
  ...
  private func setupStateMachine() {
    stateMachine.addTransitionHandler { [weak self] context in
      ...
      case (
        .acceptingVerificationRequest, .didAcceptVerificationRequest, .verificationRequestAccepted
      ):
