...
typealias LoginScreenViewModelType = StateStoreViewModelV2<
  LoginScreenViewState, LoginScreenViewAction
>
...
class LoginScreenViewModel: LoginScreenViewModelType, LoginScreenViewModelProtocol {
  ...
  init(
    ...
    let viewState = LoginScreenViewState(
  ...
  private func login() {
    ...
    Task {
      switch await authenticationService.login(
