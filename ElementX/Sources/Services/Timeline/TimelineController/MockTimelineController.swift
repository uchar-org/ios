...
class MockTimelineController: TimelineControllerProtocol {
  ...
  func sendAudio(
    ...
    if let timelineProxy {
      return await timelineProxy.sendAudio(
        url: url,
        audioInfo: audioInfo,
        caption: caption,
  ...
  func sendFile(
    ...
    if let timelineProxy {
      return await timelineProxy.sendFile(
        url: url,
        fileInfo: fileInfo,
        caption: caption,
        requestHandle: requestHandle
  ...
  func sendImage(
    ...
    if let timelineProxy {
      return await timelineProxy.sendImage(
        url: url,
  ...
  func sendLocation(
    ...
    description: String?,
    zoomLevel: UInt8?,
    assetType: MatrixRustSDK.AssetType?
  ) async -> Result<Void, TimelineControllerError> {
    if let timelineProxy {
      return await timelineProxy.sendLocation(
        body: body,
        geoURI: geoURI,
  ...
  func sendVideo(
    ...
    if let timelineProxy {
      return await timelineProxy.sendVideo(
        url: url,
        thumbnailURL: thumbnailURL,
        videoInfo: videoInfo,
        caption: caption,
  ...
  func sendVoiceMessage(
    ...
    if let timelineProxy {
      return await timelineProxy.sendVoiceMessage(
        url: url,
        audioInfo: audioInfo,
        waveform: waveform,
        requestHandle: requestHandle
  ...
  {
    if let timelineProxy {
      _ = await timelineProxy.editPoll(
  ...
  private func simulateBackPagination() async throws {
    defer {
      paginationState = TimelinePaginationState(
        backward: backPaginationResponses.isEmpty ? .endReached : .idle,
        forward: .endReached)
    }
