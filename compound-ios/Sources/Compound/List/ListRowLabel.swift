...
public struct ListRowLabel<Icon: View>: View {
  ...
  var iconBackgroundColor: Color {
    ...
    if #available(iOS 26, *) {
      ...
      return role == .destructive
        ? .compound._bgCriticalSubtleAlpha : .compound._bgSubtleSecondaryAlpha
    }
  }
  ...
  public static func `default`(
    ...
    role: ListRowLabel.Role? = nil,
    iconAlignment: VerticalAlignment = .top
  ) -> ListRowLabel where Icon == CompoundIcon {
    .default(
      title: title,
      description: description,
  ...
  public static func centeredAction(
    title: String,
    icon: Icon,
    role: ListRowLabel.Role? = nil
  ) -> ListRowLabel {
  ...
  public static func plain(
    ...
    description: String? = nil,
    role: ListRowLabel.Role? = nil
  ) -> ListRowLabel where Icon == EmptyView {
  ...
  static var previews: some View {
    Form {
      Section {
        ...
        ListRowLabel.description(
          "This is a row in the list, that only contains a description and doesn't have either an icon or a title."
        )
      }
