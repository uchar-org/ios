...
struct AuthenticationClassicAppAccountView: View {
  ...
  var profile: some View {
    VStack(spacing: 16) {
      LoadableAvatarImage(
        url: classicAppAccount.avatarURL,
...
extension ClassicAppAccount {
  fileprivate var displayableName: String {
...
struct AuthenticationClassicAppAccountView_Previews: PreviewProvider {  // Not Testable – snapshots generated by main screen.
  ...
  static var previews: some View {
    ElementNavigationStack {
      AuthenticationClassicAppAccountView(
        context: viewModel.context, classicAppAccount: classicAppAccount)
    }
