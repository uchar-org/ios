    ...
    static var previews: some View {
        VStack(spacing: 20) {
            HStack(spacing: 12) {
                ...
                RoomAvatarImage(avatar: .tombstoned, avatarSize: .room(on: .chats),
                                mediaProvider: MediaProviderMock(configuration: .init()))
            }

            HStack(spacing: 12) {
                RoomAvatarImage(avatar: .heroes([
                    .init(userID: "@user:server.com",
                          displayName: "User",
                          avatarURL: nil)
                ]),
                avatarSize: .room(on: .chats),
                ...
                RoomAvatarImage(avatar: .heroes([
                    .init(userID: "@alice:server.com", displayName: "Alice", avatarURL: nil),
