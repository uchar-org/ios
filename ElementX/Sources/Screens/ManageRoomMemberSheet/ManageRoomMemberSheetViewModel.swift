...
class ManageRoomMemberSheetViewModel: ManageRoomMemberSheetViewModelType,
    ...
    init(memberDetails: ManageRoomMemberDetails,
        ...
        super.init(initialViewState: .init(memberDetails: memberDetails, permissions: permissions),
    ...
    private func displayAlert(_ alertType: ManageRoomMemberSheetViewAlertType) {
        ...
        case .kick:
            state.bindings.alertInfo = .init(id: alertType,
                                             ...
                                             textFields: [
                                                 .init(placeholder: L10n.commonReason,
                                                       text: binding,
        ...
        case .ban:
            state.bindings.alertInfo = .init(id: alertType,
                                             ...
                                             primaryButton: .init(title: L10n.actionCancel, role: .cancel) { },
                                             secondaryButton: .init(title: L10n.screenBottomSheetManageRoomMemberBanMemberConfirmationAction) { [weak self] in
