...
extension [SpaceServiceRoom] {
  ...
  private static func makeSpaceRooms(isSpace: Bool) -> [SpaceServiceRoom] {
    ...
    return [
      SpaceServiceRoom.mock(
        id: "!\(typeName.lowercased())1:matrix.org",
        name: "Company \(typeName)",
        isSpace: isSpace),
      SpaceServiceRoom.mock(
        id: "!\(typeName.lowercased())2:matrix.org",
        ...
        joinRule: .public),
      SpaceServiceRoom.mock(
        id: "!\(typeName.lowercased())3:matrix.org",
