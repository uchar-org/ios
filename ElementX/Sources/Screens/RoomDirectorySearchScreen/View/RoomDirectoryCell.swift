...
struct RoomDirectorySearchCell: View {
  ...
  var body: some View {
    ListRow(
      label: .avatar(
        title: result.name ?? result.alias ?? result.id,
...
struct RoomDirectorySearchCell_Previews: PreviewProvider, TestablePreview {
  static var previews: some View {
    List {
      RoomDirectorySearchCell(
        result: .init(
          id: "!test_id_1:matrix.org",
