...
final class NotificationSettingsScreenCoordinator: CoordinatorProtocol {
  ...
  private let actionsSubject:
    PassthroughSubject<NotificationSettingsScreenCoordinatorAction, Never> = .init()
  ...
  private func presentEditScreen(chatType: NotificationSettingsChatType) {
    let editSettingsParameters = NotificationSettingsEditScreenCoordinatorParameters(
      navigationStackCoordinator: parameters.navigationStackCoordinator,
      chatType: chatType,
      userSession: parameters.userSession)
    let editSettingsCoordinator = NotificationSettingsEditScreenCoordinator(
      parameters: editSettingsParameters)
