...
struct TimelineReplyView: View {
        ...
        case .message(let content):
          ...
          case .image(let content):
            ReplyView(
              ...
              formattedBody: content.formattedCaption,
              icon: .init(
                kind: .mediaSource(content.thumbnailInfo?.source ?? content.imageInfo.source)))
  ...
  private struct LoadingReplyView: View {
    var body: some View {
      ReplyView(
        sender: .init(id: "@alice:matrix.org"), plainBody: "Hello world", formattedBody: nil
      )
    ...
    var body: some View {
      HStack(spacing: 8) {
        ...
        VStack(alignment: .leading, spacing: 2) {
          ...
          Text(
            context.viewState.buildMessagePreview(
              formattedBody: formattedBody, plainBody: plainBody)
          )
...
struct TimelineReplyView_Previews: PreviewProvider, TestablePreview {
  ...
  static var previewItems: [TimelineReplyView] {
    [
      ...
      TimelineReplyView(
        placement: .timeline,
        timelineItemReplyDetails: .loaded(
      ...
      TimelineReplyView(
        ...
        timelineItemReplyDetails: .loaded(
          ...
          eventID: "123",
          eventContent: .message(
            .notice(.init(body: "", formattedBody: attributedStringWithMention))))),
      TimelineReplyView(
        placement: .timeline,
        timelineItemReplyDetails: .loaded(
          sender: .init(id: "", displayName: "Bob"),
          eventID: "123",
          eventContent: .message(
            .notice(.init(body: "", formattedBody: attributedStringWithAtRoomMention))))),
      TimelineReplyView(
        placement: .timeline,
        timelineItemReplyDetails: .loaded(
          sender: .init(id: "", displayName: "Bob"),
          eventID: "123",
          eventContent: .message(
            .notice(.init(body: "", formattedBody: attributedStringWithRoomAliasMention))))),
      TimelineReplyView(
        placement: .timeline,
        timelineItemReplyDetails: .loaded(
          sender: .init(id: "", displayName: "Bob"),
          eventID: "123",
          eventContent: .message(
            .notice(.init(body: "", formattedBody: attributedStringWithRoomIDMention))))),
      TimelineReplyView(
        placement: .timeline,
        timelineItemReplyDetails: .loaded(
          sender: .init(id: "", displayName: "Bob"),
          eventID: "123",
          eventContent: .message(
            .notice(.init(body: "", formattedBody: attributedStringWithEventOnRoomIDMention))))),
      TimelineReplyView(
        placement: .timeline,
        timelineItemReplyDetails: .loaded(
          sender: .init(id: "", displayName: "Bob"),
          eventID: "123",
          eventContent: .message(
            .notice(.init(body: "", formattedBody: attributedStringWithEventOnRoomAliasMention))))),
      TimelineReplyView(
        placement: .timeline,
        timelineItemReplyDetails: .loaded(
          sender: .init(id: "", displayName: "Bob"),
