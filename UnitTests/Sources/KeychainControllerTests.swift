...
struct KeychainControllerTests {
    ...
    func addRestorationToken() {
        ...
        #expect(keychain.restorationTokenForUsername(username) == restorationToken,
    ...
    func removingRestorationToken() {
        ...
        #expect(keychain.restorationTokenForUsername(username) == nil,
    ...
    func removingSingleRestorationTokens() {
        ...
        #expect(keychain.restorationTokenForUsername("@test0:example.com") != nil,
                "The restoration token should not have been deleted.")
        #expect(keychain.restorationTokenForUsername("@test1:example.com") != nil,
                "The restoration token should not have been deleted.")
        #expect(keychain.restorationTokenForUsername("@test2:example.com") == nil,
                "The restoration token should have been deleted.")
        #expect(keychain.restorationTokenForUsername("@test3:example.com") != nil,
                "The restoration token should not have been deleted.")
        #expect(keychain.restorationTokenForUsername("@test4:example.com") != nil,
                "The restoration token should not have been deleted.")
    }
    ...
    func addPINCodeBiometricState() throws {
        ...
        #expect(keychain.pinCodeBiometricState() == data,
    ...
    func updatePINCodeBiometricState() throws {
        ...
        #expect(keychain.pinCodeBiometricState() == newData,
    ...
    func removePINCodeBiometricState() throws {
        ...
        #expect(!keychain.containsPINCodeBiometricState(),
                "The keychain should no longer contain the biometric state.")
        #expect(keychain.pinCodeBiometricState() == nil,
