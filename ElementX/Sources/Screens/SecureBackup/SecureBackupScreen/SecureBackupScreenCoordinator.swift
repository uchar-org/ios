...
final class SecureBackupScreenCoordinator: CoordinatorProtocol {
  ...
  private let actionsSubject: PassthroughSubject<SecureBackupScreenCoordinatorAction, Never> =
    .init()
  ...
  init(parameters: SecureBackupScreenCoordinatorParameters) {
    ...
    viewModel = SecureBackupScreenViewModel(
      secureBackupController: parameters.clientProxy.secureBackupController,
