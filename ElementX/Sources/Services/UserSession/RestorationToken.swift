...
extension RestorationToken: Codable {
  init(from decoder: Decoder) throws {
    ...
    self = try .init(
      ...
      pusherNotificationClientIdentifier: container.decodeIfPresent(
        String.self, forKey: .pusherNotificationClientIdentifier))
  }
  ...
  func encode(to encoder: any Encoder) throws {
    ...
    try container.encode(
      pusherNotificationClientIdentifier, forKey: .pusherNotificationClientIdentifier)
  }
}
