...
struct BugReportScreen: View {
  ...
  var photosPickerTitle: String {
    context.viewState.screenshot == nil
      ? L10n.screenBugReportAttachScreenshot : L10n.screenBugReportEditScreenshot
  }
  ...
  private var textFieldSection: some View {
    Section {
      ListRow(
        label: .plain(title: L10n.screenBugReportEditorPlaceholder),
  ...
  private var sendLogsSection: some View {
    Section {
      ...
      if canSendLogFiles {
        ...
        Label(
          L10n.screenBugReportIncludeLogsError, icon: \.errorSolid, iconSize: .xSmall,
  ...
  private var canContactSection: some View {
    Section {
      ListRow(
        label: .plain(title: L10n.screenBugReportContactMeTitle),
...
struct BugReportScreen_Previews: PreviewProvider, TestablePreview {
  static var previews: some View {
    ElementNavigationStack {
      ...
      BugReportScreen(
        context: BugReportScreenViewModel(
