...
open class ClientSDKMock: MatrixRustSDK.Client, @unchecked Sendable {
  ...
  open var customLoginWithJwtJwtInitialDeviceNameDeviceIdReceivedArguments:
    (jwt: String, initialDeviceName: String?, deviceId: String?)?
  open var customLoginWithJwtJwtInitialDeviceNameDeviceIdReceivedInvocations:
    [(jwt: String, initialDeviceName: String?, deviceId: String?)] = []
  open var customLoginWithJwtJwtInitialDeviceNameDeviceIdClosure:
    ((String, String?, String?) async throws -> Void)?

  open override func customLoginWithJwt(jwt: String, initialDeviceName: String?, deviceId: String?)
    async throws
  {
    ...
    customLoginWithJwtJwtInitialDeviceNameDeviceIdReceivedArguments = (
      jwt: jwt, initialDeviceName: initialDeviceName, deviceId: deviceId
    )
    DispatchQueue.main.async {
      self.customLoginWithJwtJwtInitialDeviceNameDeviceIdReceivedInvocations.append(
        (jwt: jwt, initialDeviceName: initialDeviceName, deviceId: deviceId))
    }
    try await customLoginWithJwtJwtInitialDeviceNameDeviceIdClosure?(
      jwt, initialDeviceName, deviceId)
  }
  ...
  open var deactivateAccountAuthDataEraseDataReceivedArguments:
    (authData: AuthData?, eraseData: Bool)?
  open var deactivateAccountAuthDataEraseDataReceivedInvocations:
    [(authData: AuthData?, eraseData: Bool)] = []
  ...
  open override func deactivateAccount(authData: AuthData?, eraseData: Bool) async throws {
    ...
    DispatchQueue.main.async {
      self.deactivateAccountAuthDataEraseDataReceivedInvocations.append(
        (authData: authData, eraseData: eraseData))
    }
  ...
  open var getMediaFileMediaSourceFilenameMimeTypeUseCacheTempDirReceivedArguments:
    (
      mediaSource: MediaSource, filename: String?, mimeType: String, useCache: Bool,
      tempDir: String?
    )?
  open var getMediaFileMediaSourceFilenameMimeTypeUseCacheTempDirReceivedInvocations:
    [(
      mediaSource: MediaSource, filename: String?, mimeType: String, useCache: Bool,
      tempDir: String?
    )] = []

  open var getMediaFileMediaSourceFilenameMimeTypeUseCacheTempDirUnderlyingReturnValue:
    MediaFileHandle!
  ...
  open var getMediaFileMediaSourceFilenameMimeTypeUseCacheTempDirClosure:
    ((MediaSource, String?, String, Bool, String?) async throws -> MediaFileHandle)?

  open override func getMediaFile(
    mediaSource: MediaSource, filename: String?, mimeType: String, useCache: Bool, tempDir: String?
  ) async throws -> MediaFileHandle {
    ...
    getMediaFileMediaSourceFilenameMimeTypeUseCacheTempDirReceivedArguments = (
      mediaSource: mediaSource, filename: filename, mimeType: mimeType, useCache: useCache,
      tempDir: tempDir
    )
    DispatchQueue.main.async {
      self.getMediaFileMediaSourceFilenameMimeTypeUseCacheTempDirReceivedInvocations.append(
        (
          mediaSource: mediaSource, filename: filename, mimeType: mimeType, useCache: useCache,
          tempDir: tempDir
        ))
    }
    if let getMediaFileMediaSourceFilenameMimeTypeUseCacheTempDirClosure =
      getMediaFileMediaSourceFilenameMimeTypeUseCacheTempDirClosure
    {
      return try await getMediaFileMediaSourceFilenameMimeTypeUseCacheTempDirClosure(
        mediaSource, filename, mimeType, useCache, tempDir)
    } else {
  ...
  open var getMediaThumbnailMediaSourceWidthHeightReceivedArguments:
    (mediaSource: MediaSource, width: UInt64, height: UInt64)?
  open var getMediaThumbnailMediaSourceWidthHeightReceivedInvocations:
    [(mediaSource: MediaSource, width: UInt64, height: UInt64)] = []
  ...
  open var getMediaThumbnailMediaSourceWidthHeightClosure:
    ((MediaSource, UInt64, UInt64) async throws -> Data)?

  open override func getMediaThumbnail(mediaSource: MediaSource, width: UInt64, height: UInt64)
    async throws -> Data
  {
    ...
    getMediaThumbnailMediaSourceWidthHeightReceivedArguments = (
      mediaSource: mediaSource, width: width, height: height
    )
    DispatchQueue.main.async {
      self.getMediaThumbnailMediaSourceWidthHeightReceivedInvocations.append(
        (mediaSource: mediaSource, width: width, height: height))
    }
    if let getMediaThumbnailMediaSourceWidthHeightClosure =
  ...
  open var getRoomPreviewFromRoomIdRoomIdViaServersReceivedArguments:
    (roomId: String, viaServers: [String])?
  open var getRoomPreviewFromRoomIdRoomIdViaServersReceivedInvocations:
    [(roomId: String, viaServers: [String])] = []
  ...
  open var getRoomPreviewFromRoomIdRoomIdViaServersClosure:
    ((String, [String]) async throws -> RoomPreview)?

  open override func getRoomPreviewFromRoomId(roomId: String, viaServers: [String]) async throws
    -> RoomPreview
  {
    ...
    getRoomPreviewFromRoomIdRoomIdViaServersReceivedArguments = (
      roomId: roomId, viaServers: viaServers
    )
    DispatchQueue.main.async {
      self.getRoomPreviewFromRoomIdRoomIdViaServersReceivedInvocations.append(
        (roomId: roomId, viaServers: viaServers))
    }
    if let getRoomPreviewFromRoomIdRoomIdViaServersClosure =
      getRoomPreviewFromRoomIdRoomIdViaServersClosure
    {
  ...
  open var getSessionVerificationControllerClosure:
    (() async throws -> SessionVerificationController)?

  open override func getSessionVerificationController() async throws
  ...
  open var joinRoomByIdOrAliasRoomIdOrAliasServerNamesReceivedArguments:
    (roomIdOrAlias: String, serverNames: [String])?
  open var joinRoomByIdOrAliasRoomIdOrAliasServerNamesReceivedInvocations:
    [(roomIdOrAlias: String, serverNames: [String])] = []
  ...
  open var joinRoomByIdOrAliasRoomIdOrAliasServerNamesClosure:
    ((String, [String]) async throws -> Room)?

  open override func joinRoomByIdOrAlias(roomIdOrAlias: String, serverNames: [String]) async throws
    -> Room
  {
    ...
    joinRoomByIdOrAliasRoomIdOrAliasServerNamesReceivedArguments = (
      roomIdOrAlias: roomIdOrAlias, serverNames: serverNames
    )
    DispatchQueue.main.async {
      self.joinRoomByIdOrAliasRoomIdOrAliasServerNamesReceivedInvocations.append(
        (roomIdOrAlias: roomIdOrAlias, serverNames: serverNames))
    }
    if let joinRoomByIdOrAliasRoomIdOrAliasServerNamesClosure =
      joinRoomByIdOrAliasRoomIdOrAliasServerNamesClosure
    {
      return try await joinRoomByIdOrAliasRoomIdOrAliasServerNamesClosure(
        roomIdOrAlias, serverNames)
    } else {
  ...
  open var knockRoomIdOrAliasReasonServerNamesReceivedArguments:
    (roomIdOrAlias: String, reason: String?, serverNames: [String])?
  open var knockRoomIdOrAliasReasonServerNamesReceivedInvocations:
    [(roomIdOrAlias: String, reason: String?, serverNames: [String])] = []
  ...
  open var knockRoomIdOrAliasReasonServerNamesClosure:
    ((String, String?, [String]) async throws -> Room)?

  open override func knock(roomIdOrAlias: String, reason: String?, serverNames: [String])
    async throws -> Room
  {
    ...
    knockRoomIdOrAliasReasonServerNamesReceivedArguments = (
      roomIdOrAlias: roomIdOrAlias, reason: reason, serverNames: serverNames
    )
    DispatchQueue.main.async {
      self.knockRoomIdOrAliasReasonServerNamesReceivedInvocations.append(
        (roomIdOrAlias: roomIdOrAlias, reason: reason, serverNames: serverNames))
    }
    if let knockRoomIdOrAliasReasonServerNamesClosure = knockRoomIdOrAliasReasonServerNamesClosure {
      return try await knockRoomIdOrAliasReasonServerNamesClosure(
        roomIdOrAlias, reason, serverNames)
    } else {
  ...
  open var loginUsernamePasswordInitialDeviceNameDeviceIdReceivedArguments:
    (username: String, password: String, initialDeviceName: String?, deviceId: String?)?
  open var loginUsernamePasswordInitialDeviceNameDeviceIdReceivedInvocations:
    [(username: String, password: String, initialDeviceName: String?, deviceId: String?)] = []
  open var loginUsernamePasswordInitialDeviceNameDeviceIdClosure:
    ((String, String, String?, String?) async throws -> Void)?

  open override func login(
    username: String, password: String, initialDeviceName: String?, deviceId: String?
  ) async throws {
    ...
    DispatchQueue.main.async {
      self.loginUsernamePasswordInitialDeviceNameDeviceIdReceivedInvocations.append(
        (
          username: username, password: password, initialDeviceName: initialDeviceName,
          deviceId: deviceId
        ))
    }
    try await loginUsernamePasswordInitialDeviceNameDeviceIdClosure?(
      username, password, initialDeviceName, deviceId)
  }
  ...
  open var loginWithEmailEmailPasswordInitialDeviceNameDeviceIdReceivedArguments:
    (email: String, password: String, initialDeviceName: String?, deviceId: String?)?
  open var loginWithEmailEmailPasswordInitialDeviceNameDeviceIdReceivedInvocations:
    [(email: String, password: String, initialDeviceName: String?, deviceId: String?)] = []
  open var loginWithEmailEmailPasswordInitialDeviceNameDeviceIdClosure:
    ((String, String, String?, String?) async throws -> Void)?

  open override func loginWithEmail(
    email: String, password: String, initialDeviceName: String?, deviceId: String?
  ) async throws {
    ...
    loginWithEmailEmailPasswordInitialDeviceNameDeviceIdReceivedArguments = (
      email: email, password: password, initialDeviceName: initialDeviceName, deviceId: deviceId
    )
    DispatchQueue.main.async {
      self.loginWithEmailEmailPasswordInitialDeviceNameDeviceIdReceivedInvocations.append(
        (email: email, password: password, initialDeviceName: initialDeviceName, deviceId: deviceId)
      )
    }
    try await loginWithEmailEmailPasswordInitialDeviceNameDeviceIdClosure?(
      email, password, initialDeviceName, deviceId)
  }
  ...
  open var newLoginWithQrCodeHandlerOauthConfigurationReceivedOauthConfiguration:
    OAuthConfiguration?
  ...
  open var newLoginWithQrCodeHandlerOauthConfigurationClosure:
    ((OAuthConfiguration) -> LoginWithQrCodeHandler)?

  open override func newLoginWithQrCodeHandler(oauthConfiguration: OAuthConfiguration)
    -> LoginWithQrCodeHandler
  {
    ...
    if let newLoginWithQrCodeHandlerOauthConfigurationClosure =
      newLoginWithQrCodeHandlerOauthConfigurationClosure
    {
  ...
  open var notificationClientProcessSetupClosure:
    ((NotificationProcessSetup) async throws -> NotificationClient)?

  open override func notificationClient(processSetup: NotificationProcessSetup) async throws
    -> NotificationClient
  {
  ...
  open var observeAccountDataEventEventTypeListenerReceivedArguments:
    (eventType: AccountDataEventType, listener: AccountDataListener)?
  open var observeAccountDataEventEventTypeListenerReceivedInvocations:
    [(eventType: AccountDataEventType, listener: AccountDataListener)] = []
  ...
  open var observeAccountDataEventEventTypeListenerClosure:
    ((AccountDataEventType, AccountDataListener) -> TaskHandle)?

  open override func observeAccountDataEvent(
    eventType: AccountDataEventType, listener: AccountDataListener
  ) -> TaskHandle {
    observeAccountDataEventEventTypeListenerCallsCount += 1
    observeAccountDataEventEventTypeListenerReceivedArguments = (
      eventType: eventType, listener: listener
    )
    DispatchQueue.main.async {
      self.observeAccountDataEventEventTypeListenerReceivedInvocations.append(
        (eventType: eventType, listener: listener))
    }
    if let observeAccountDataEventEventTypeListenerClosure =
      observeAccountDataEventEventTypeListenerClosure
    {
  ...
  open var observeRoomAccountDataEventRoomIdEventTypeListenerReceivedArguments:
    (roomId: String, eventType: RoomAccountDataEventType, listener: RoomAccountDataListener)?
  open var observeRoomAccountDataEventRoomIdEventTypeListenerReceivedInvocations:
    [(roomId: String, eventType: RoomAccountDataEventType, listener: RoomAccountDataListener)] = []
  ...
  open var observeRoomAccountDataEventRoomIdEventTypeListenerClosure:
    ((String, RoomAccountDataEventType, RoomAccountDataListener) throws -> TaskHandle)?

  open override func observeRoomAccountDataEvent(
    roomId: String, eventType: RoomAccountDataEventType, listener: RoomAccountDataListener
  ) throws -> TaskHandle {
    ...
    observeRoomAccountDataEventRoomIdEventTypeListenerReceivedArguments = (
      roomId: roomId, eventType: eventType, listener: listener
    )
    DispatchQueue.main.async {
      self.observeRoomAccountDataEventRoomIdEventTypeListenerReceivedInvocations.append(
        (roomId: roomId, eventType: eventType, listener: listener))
    }
    if let observeRoomAccountDataEventRoomIdEventTypeListenerClosure =
      observeRoomAccountDataEventRoomIdEventTypeListenerClosure
    {
      return try observeRoomAccountDataEventRoomIdEventTypeListenerClosure(
        roomId, eventType, listener)
    } else {
  ...
  open var restoreSessionWithSessionRoomLoadSettingsReceivedArguments:
    (session: Session, roomLoadSettings: RoomLoadSettings)?
  open var restoreSessionWithSessionRoomLoadSettingsReceivedInvocations:
    [(session: Session, roomLoadSettings: RoomLoadSettings)] = []
  open var restoreSessionWithSessionRoomLoadSettingsClosure:
    ((Session, RoomLoadSettings) async throws -> Void)?

  open override func restoreSessionWith(session: Session, roomLoadSettings: RoomLoadSettings)
    async throws
  {
    ...
    restoreSessionWithSessionRoomLoadSettingsReceivedArguments = (
      session: session, roomLoadSettings: roomLoadSettings
    )
    DispatchQueue.main.async {
      self.restoreSessionWithSessionRoomLoadSettingsReceivedInvocations.append(
        (session: session, roomLoadSettings: roomLoadSettings))
    }
  ...
  open override func searchUsers(searchTerm: String, limit: UInt64) async throws
    -> SearchUsersResults
  {
    ...
    DispatchQueue.main.async {
      self.searchUsersSearchTermLimitReceivedInvocations.append(
  ...
  open var setAccountDataEventTypeContentReceivedInvocations:
  ...
  open override func setAccountData(eventType: String, content: String) async throws {
    ...
    DispatchQueue.main.async {
      self.setAccountDataEventTypeContentReceivedInvocations.append(
  ...
  open var setPusherIdentifiersKindAppDisplayNameDeviceDisplayNameProfileTagLangThrowableError:
    Error?
  open
    var setPusherIdentifiersKindAppDisplayNameDeviceDisplayNameProfileTagLangUnderlyingCallsCount =
    0
  open var setPusherIdentifiersKindAppDisplayNameDeviceDisplayNameProfileTagLangCallsCount: Int {
    get {
      if Thread.isMainThread {
        return
          setPusherIdentifiersKindAppDisplayNameDeviceDisplayNameProfileTagLangUnderlyingCallsCount
      } else {
        var returnValue: Int? = nil
        DispatchQueue.main.sync {
          returnValue =
  ...
  open var setPusherIdentifiersKindAppDisplayNameDeviceDisplayNameProfileTagLangReceivedArguments:
    (
      identifiers: PusherIdentifiers, kind: PusherKind, appDisplayName: String,
      deviceDisplayName: String, profileTag: String?, lang: String
    )?
  open var setPusherIdentifiersKindAppDisplayNameDeviceDisplayNameProfileTagLangReceivedInvocations:
    [(
      identifiers: PusherIdentifiers, kind: PusherKind, appDisplayName: String,
      deviceDisplayName: String, profileTag: String?, lang: String
    )] = []
  open var setPusherIdentifiersKindAppDisplayNameDeviceDisplayNameProfileTagLangClosure:
    ((PusherIdentifiers, PusherKind, String, String, String?, String) async throws -> Void)?

  open override func setPusher(
    identifiers: PusherIdentifiers, kind: PusherKind, appDisplayName: String,
    deviceDisplayName: String, profileTag: String?, lang: String
  ) async throws {
    if let error =
      setPusherIdentifiersKindAppDisplayNameDeviceDisplayNameProfileTagLangThrowableError
    {
      throw error
    }
    setPusherIdentifiersKindAppDisplayNameDeviceDisplayNameProfileTagLangCallsCount += 1
    setPusherIdentifiersKindAppDisplayNameDeviceDisplayNameProfileTagLangReceivedArguments = (
      identifiers: identifiers, kind: kind, appDisplayName: appDisplayName,
      deviceDisplayName: deviceDisplayName, profileTag: profileTag, lang: lang
    )
    DispatchQueue.main.async {
      self.setPusherIdentifiersKindAppDisplayNameDeviceDisplayNameProfileTagLangReceivedInvocations
        .append(
          (
            identifiers: identifiers, kind: kind, appDisplayName: appDisplayName,
            deviceDisplayName: deviceDisplayName, profileTag: profileTag, lang: lang
    ...
    try await setPusherIdentifiersKindAppDisplayNameDeviceDisplayNameProfileTagLangClosure?(
      identifiers, kind, appDisplayName, deviceDisplayName, profileTag, lang)
  }
  ...
  open var startSsoLoginRedirectUrlIdpIdReceivedInvocations:
    [(redirectUrl: String, idpId: String?)] = []
  ...
  open override func startSsoLogin(redirectUrl: String, idpId: String?) async throws -> SsoHandler {
    ...
    DispatchQueue.main.async {
      self.startSsoLoginRedirectUrlIdpIdReceivedInvocations.append(
        (redirectUrl: redirectUrl, idpId: idpId))
    }
  ...
  open var subscribeToDuplicateKeyUploadErrorsListenerReceivedListener:
    DuplicateKeyUploadErrorListener?
  open var subscribeToDuplicateKeyUploadErrorsListenerReceivedInvocations:
    [DuplicateKeyUploadErrorListener] = []
  ...
  open var subscribeToDuplicateKeyUploadErrorsListenerClosure:
    ((DuplicateKeyUploadErrorListener) -> TaskHandle)?

  open override func subscribeToDuplicateKeyUploadErrors(listener: DuplicateKeyUploadErrorListener)
    -> TaskHandle
  {
    ...
    if let subscribeToDuplicateKeyUploadErrorsListenerClosure =
      subscribeToDuplicateKeyUploadErrorsListenerClosure
    {
  ...
  open var subscribeToMediaPreviewConfigListenerClosure:
    ((MediaPreviewConfigListener) async throws -> TaskHandle)?

  open override func subscribeToMediaPreviewConfig(listener: MediaPreviewConfigListener)
    async throws -> TaskHandle
  {
    ...
    if let subscribeToMediaPreviewConfigListenerClosure =
      subscribeToMediaPreviewConfigListenerClosure
    {
  ...
  open var subscribeToOwnBeaconInfoUpdatesListenerClosure:
    ((BeaconInfoListener) throws -> TaskHandle)?

  open override func subscribeToOwnBeaconInfoUpdates(listener: BeaconInfoListener) throws
    -> TaskHandle
  {
    ...
    if let subscribeToOwnBeaconInfoUpdatesListenerClosure =
      subscribeToOwnBeaconInfoUpdatesListenerClosure
    {
  ...
  open var subscribeToRoomInfoRoomIdListenerReceivedArguments:
    (roomId: String, listener: RoomInfoListener)?
  open var subscribeToRoomInfoRoomIdListenerReceivedInvocations:
    [(roomId: String, listener: RoomInfoListener)] = []
  ...
  open var subscribeToRoomInfoRoomIdListenerClosure:
    ((String, RoomInfoListener) async throws -> TaskHandle)?

  open override func subscribeToRoomInfo(roomId: String, listener: RoomInfoListener) async throws
    -> TaskHandle
  {
    ...
    DispatchQueue.main.async {
      self.subscribeToRoomInfoRoomIdListenerReceivedInvocations.append(
        (roomId: roomId, listener: listener))
    }
  ...
  open var subscribeToSendQueueUpdatesListenerClosure:
    ((SendQueueRoomUpdateListener) async throws -> TaskHandle)?

  open override func subscribeToSendQueueUpdates(listener: SendQueueRoomUpdateListener) async throws
    -> TaskHandle
  {
  ...
  open var syncOnceV2SettingsThrowableError: Error?
  open var syncOnceV2SettingsUnderlyingCallsCount = 0
  open var syncOnceV2SettingsCallsCount: Int {
    get {
      if Thread.isMainThread {
        return syncOnceV2SettingsUnderlyingCallsCount
      } else {
        var returnValue: Int? = nil
        DispatchQueue.main.sync {
          returnValue = syncOnceV2SettingsUnderlyingCallsCount
        }
    ...
    set {
      if Thread.isMainThread {
        syncOnceV2SettingsUnderlyingCallsCount = newValue
      } else {
        DispatchQueue.main.sync {
          syncOnceV2SettingsUnderlyingCallsCount = newValue
        }
  ...
  open var syncOnceV2SettingsCalled: Bool {
    return syncOnceV2SettingsCallsCount > 0
  }
  open var syncOnceV2SettingsReceivedSettings: SyncSettingsV2?
  open var syncOnceV2SettingsReceivedInvocations: [SyncSettingsV2] = []

  open var syncOnceV2SettingsUnderlyingReturnValue: SyncResponseV2!
  open var syncOnceV2SettingsReturnValue: SyncResponseV2! {
    get {
      if Thread.isMainThread {
        return syncOnceV2SettingsUnderlyingReturnValue
      } else {
        var returnValue: SyncResponseV2? = nil
        DispatchQueue.main.sync {
          returnValue = syncOnceV2SettingsUnderlyingReturnValue
        }
    ...
    set {
      if Thread.isMainThread {
        syncOnceV2SettingsUnderlyingReturnValue = newValue
      } else {
        DispatchQueue.main.sync {
          syncOnceV2SettingsUnderlyingReturnValue = newValue
        }
  ...
  open var syncOnceV2SettingsClosure: ((SyncSettingsV2) async throws -> SyncResponseV2)?

  open override func syncOnceV2(settings: SyncSettingsV2) async throws -> SyncResponseV2 {
    if let error = syncOnceV2SettingsThrowableError {
      throw error
    }
    syncOnceV2SettingsCallsCount += 1
    syncOnceV2SettingsReceivedSettings = settings
    DispatchQueue.main.async {
      self.syncOnceV2SettingsReceivedInvocations.append(settings)
    }
    if let syncOnceV2SettingsClosure = syncOnceV2SettingsClosure {
      return try await syncOnceV2SettingsClosure(settings)
    } else {
      return syncOnceV2SettingsReturnValue
    }
  }
  ...
  open var syncV2SettingsListenerUnderlyingCallsCount = 0
  open var syncV2SettingsListenerCallsCount: Int {
    get {
      if Thread.isMainThread {
        return syncV2SettingsListenerUnderlyingCallsCount
      } else {
        var returnValue: Int? = nil
        DispatchQueue.main.sync {
          returnValue = syncV2SettingsListenerUnderlyingCallsCount
        }
    ...
    set {
      if Thread.isMainThread {
        syncV2SettingsListenerUnderlyingCallsCount = newValue
      } else {
        DispatchQueue.main.sync {
          syncV2SettingsListenerUnderlyingCallsCount = newValue
        }
  ...
  open var syncV2SettingsListenerCalled: Bool {
    return syncV2SettingsListenerCallsCount > 0
  }
  open var syncV2SettingsListenerReceivedArguments:
    (settings: SyncSettingsV2, listener: SyncListenerV2)?
  open var syncV2SettingsListenerReceivedInvocations:
    [(settings: SyncSettingsV2, listener: SyncListenerV2)] = []

  open var syncV2SettingsListenerUnderlyingReturnValue: TaskHandle!
  open var syncV2SettingsListenerReturnValue: TaskHandle! {
    get {
      if Thread.isMainThread {
        return syncV2SettingsListenerUnderlyingReturnValue
      } else {
        var returnValue: TaskHandle? = nil
        DispatchQueue.main.sync {
          returnValue = syncV2SettingsListenerUnderlyingReturnValue
        }
    ...
    set {
      if Thread.isMainThread {
        syncV2SettingsListenerUnderlyingReturnValue = newValue
      } else {
        DispatchQueue.main.sync {
          syncV2SettingsListenerUnderlyingReturnValue = newValue
        }
  ...
  open var syncV2SettingsListenerClosure: ((SyncSettingsV2, SyncListenerV2) -> TaskHandle)?

  open override func syncV2(settings: SyncSettingsV2, listener: SyncListenerV2) -> TaskHandle {
    syncV2SettingsListenerCallsCount += 1
    syncV2SettingsListenerReceivedArguments = (settings: settings, listener: listener)
    DispatchQueue.main.async {
      self.syncV2SettingsListenerReceivedInvocations.append(
        (settings: settings, listener: listener))
    }
    if let syncV2SettingsListenerClosure = syncV2SettingsListenerClosure {
      return syncV2SettingsListenerClosure(settings, listener)
    } else {
      return syncV2SettingsListenerReturnValue
    }
  }
  ...
  open var uploadMediaMimeTypeDataProgressWatcherReceivedArguments:
    (mimeType: String, data: Data, progressWatcher: ProgressWatcher?)?
  open var uploadMediaMimeTypeDataProgressWatcherReceivedInvocations:
    [(mimeType: String, data: Data, progressWatcher: ProgressWatcher?)] = []
  ...
  open var uploadMediaMimeTypeDataProgressWatcherClosure:
    ((String, Data, ProgressWatcher?) async throws -> String)?

  open override func uploadMedia(mimeType: String, data: Data, progressWatcher: ProgressWatcher?)
    async throws -> String
  {
    ...
    uploadMediaMimeTypeDataProgressWatcherReceivedArguments = (
      mimeType: mimeType, data: data, progressWatcher: progressWatcher
    )
    DispatchQueue.main.async {
      self.uploadMediaMimeTypeDataProgressWatcherReceivedInvocations.append(
        (mimeType: mimeType, data: data, progressWatcher: progressWatcher))
    }
    if let uploadMediaMimeTypeDataProgressWatcherClosure =
      uploadMediaMimeTypeDataProgressWatcherClosure
    {
      return try await uploadMediaMimeTypeDataProgressWatcherClosure(
        mimeType, data, progressWatcher)
    } else {
  ...
  open var urlForOauthOauthConfigurationPromptLoginHintDeviceIdAdditionalScopesThrowableError:
    Error?
  open
    var urlForOauthOauthConfigurationPromptLoginHintDeviceIdAdditionalScopesUnderlyingCallsCount = 0
  ...
  open var urlForOauthOauthConfigurationPromptLoginHintDeviceIdAdditionalScopesReceivedArguments:
    (
      oauthConfiguration: OAuthConfiguration, prompt: OAuthPrompt?, loginHint: String?,
      deviceId: String?, additionalScopes: [String]?
    )?
  open var urlForOauthOauthConfigurationPromptLoginHintDeviceIdAdditionalScopesReceivedInvocations:
    [(
      oauthConfiguration: OAuthConfiguration, prompt: OAuthPrompt?, loginHint: String?,
      deviceId: String?, additionalScopes: [String]?
    )] = []
  ...
  open
    var urlForOauthOauthConfigurationPromptLoginHintDeviceIdAdditionalScopesUnderlyingReturnValue:
    OAuthAuthorizationData!
  open var urlForOauthOauthConfigurationPromptLoginHintDeviceIdAdditionalScopesReturnValue:
    OAuthAuthorizationData!
  {
    get {
      if Thread.isMainThread {
  ...
  open var urlForOauthOauthConfigurationPromptLoginHintDeviceIdAdditionalScopesClosure:
    (
      (OAuthConfiguration, OAuthPrompt?, String?, String?, [String]?) async throws ->
        OAuthAuthorizationData
    )?

  open override func urlForOauth(
    oauthConfiguration: OAuthConfiguration, prompt: OAuthPrompt?, loginHint: String?,
    deviceId: String?, additionalScopes: [String]?
  ) async throws -> OAuthAuthorizationData {
    if let error =
      urlForOauthOauthConfigurationPromptLoginHintDeviceIdAdditionalScopesThrowableError
    {
      throw error
    }
    urlForOauthOauthConfigurationPromptLoginHintDeviceIdAdditionalScopesCallsCount += 1
    urlForOauthOauthConfigurationPromptLoginHintDeviceIdAdditionalScopesReceivedArguments = (
      oauthConfiguration: oauthConfiguration, prompt: prompt, loginHint: loginHint,
      deviceId: deviceId, additionalScopes: additionalScopes
    )
    DispatchQueue.main.async {
      self.urlForOauthOauthConfigurationPromptLoginHintDeviceIdAdditionalScopesReceivedInvocations
        .append(
          (
            oauthConfiguration: oauthConfiguration, prompt: prompt, loginHint: loginHint,
            deviceId: deviceId, additionalScopes: additionalScopes
    ...
    {
      return try await urlForOauthOauthConfigurationPromptLoginHintDeviceIdAdditionalScopesClosure(
  ...
  open var searchMessagesQueryFilterNumResultsPerBatchReceivedArguments:
    (query: String, filter: SearchRoomFilter, numResultsPerBatch: UInt32)?
  open var searchMessagesQueryFilterNumResultsPerBatchReceivedInvocations:
    [(query: String, filter: SearchRoomFilter, numResultsPerBatch: UInt32)] = []
  ...
  open var searchMessagesQueryFilterNumResultsPerBatchClosure:
    ((String, SearchRoomFilter, UInt32) async throws -> GlobalSearchIterator)?

  open override func searchMessages(
    query: String, filter: SearchRoomFilter, numResultsPerBatch: UInt32
  ) async throws -> GlobalSearchIterator {
    ...
    searchMessagesQueryFilterNumResultsPerBatchReceivedArguments = (
      query: query, filter: filter, numResultsPerBatch: numResultsPerBatch
    )
    DispatchQueue.main.async {
      self.searchMessagesQueryFilterNumResultsPerBatchReceivedInvocations.append(
        (query: query, filter: filter, numResultsPerBatch: numResultsPerBatch))
    }
    if let searchMessagesQueryFilterNumResultsPerBatchClosure =
      searchMessagesQueryFilterNumResultsPerBatchClosure
    {
      return try await searchMessagesQueryFilterNumResultsPerBatchClosure(
        query, filter, numResultsPerBatch)
    } else {
...
open class ClientBuilderSDKMock: MatrixRustSDK.ClientBuilder, @unchecked Sendable {
  ...
  open override func autoEnableCrossSigning(autoEnableCrossSigning: Bool) -> ClientBuilder {
    ...
    autoEnableCrossSigningAutoEnableCrossSigningReceivedAutoEnableCrossSigning =
      autoEnableCrossSigning
    DispatchQueue.main.async {
      self.autoEnableCrossSigningAutoEnableCrossSigningReceivedInvocations.append(
        autoEnableCrossSigning)
    }
    if let autoEnableCrossSigningAutoEnableCrossSigningClosure =
      autoEnableCrossSigningAutoEnableCrossSigningClosure
    {
  ...
  open var backupDownloadStrategyBackupDownloadStrategyReceivedBackupDownloadStrategy:
    BackupDownloadStrategy?
  open var backupDownloadStrategyBackupDownloadStrategyReceivedInvocations:
    [BackupDownloadStrategy] = []
  ...
  open var backupDownloadStrategyBackupDownloadStrategyClosure:
    ((BackupDownloadStrategy) -> ClientBuilder)?

  open override func backupDownloadStrategy(backupDownloadStrategy: BackupDownloadStrategy)
    -> ClientBuilder
  {
    backupDownloadStrategyBackupDownloadStrategyCallsCount += 1
    backupDownloadStrategyBackupDownloadStrategyReceivedBackupDownloadStrategy =
      backupDownloadStrategy
    DispatchQueue.main.async {
      self.backupDownloadStrategyBackupDownloadStrategyReceivedInvocations.append(
        backupDownloadStrategy)
    }
    if let backupDownloadStrategyBackupDownloadStrategyClosure =
      backupDownloadStrategyBackupDownloadStrategyClosure
    {
  ...
  open var crossProcessLockConfigCrossProcessLockConfigReceivedCrossProcessLockConfig:
    CrossProcessLockConfig?
  open var crossProcessLockConfigCrossProcessLockConfigReceivedInvocations:
    [CrossProcessLockConfig] = []
  ...
  open var crossProcessLockConfigCrossProcessLockConfigClosure:
    ((CrossProcessLockConfig) -> ClientBuilder)?

  open override func crossProcessLockConfig(crossProcessLockConfig: CrossProcessLockConfig)
    -> ClientBuilder
  {
    crossProcessLockConfigCrossProcessLockConfigCallsCount += 1
    crossProcessLockConfigCrossProcessLockConfigReceivedCrossProcessLockConfig =
      crossProcessLockConfig
    DispatchQueue.main.async {
      self.crossProcessLockConfigCrossProcessLockConfigReceivedInvocations.append(
        crossProcessLockConfig)
    }
    if let crossProcessLockConfigCrossProcessLockConfigClosure =
      crossProcessLockConfigCrossProcessLockConfigClosure
    {
  ...
  open var enableShareHistoryOnInviteEnableShareHistoryOnInviteReceivedEnableShareHistoryOnInvite:
    Bool?
  ...
  open override func enableShareHistoryOnInvite(enableShareHistoryOnInvite: Bool) -> ClientBuilder {
    ...
    enableShareHistoryOnInviteEnableShareHistoryOnInviteReceivedEnableShareHistoryOnInvite =
      enableShareHistoryOnInvite
    DispatchQueue.main.async {
      self.enableShareHistoryOnInviteEnableShareHistoryOnInviteReceivedInvocations.append(
        enableShareHistoryOnInvite)
    }
    if let enableShareHistoryOnInviteEnableShareHistoryOnInviteClosure =
      enableShareHistoryOnInviteEnableShareHistoryOnInviteClosure
    {
  ...
  open override func serverNameOrHomeserverUrl(serverNameOrUrl: String) -> ClientBuilder {
    ...
    if let serverNameOrHomeserverUrlServerNameOrUrlClosure =
      serverNameOrHomeserverUrlServerNameOrUrlClosure
    {
  ...
  open var sessionPathsDataPathCachePathReceivedInvocations:
    [(dataPath: String, cachePath: String)] = []
  ...
  open override func sessionPaths(dataPath: String, cachePath: String) -> ClientBuilder {
    ...
    DispatchQueue.main.async {
      self.sessionPathsDataPathCachePathReceivedInvocations.append(
        (dataPath: dataPath, cachePath: cachePath))
    }
  ...
  open var slidingSyncVersionBuilderVersionBuilderClosure:
    ((SlidingSyncVersionBuilder) -> ClientBuilder)?

  open override func slidingSyncVersionBuilder(versionBuilder: SlidingSyncVersionBuilder)
    -> ClientBuilder
  {
    ...
    if let slidingSyncVersionBuilderVersionBuilderClosure =
      slidingSyncVersionBuilderVersionBuilderClosure
    {
  ...
  open var threadsEnabledEnabledThreadSubscriptionsReceivedArguments:
    (enabled: Bool, threadSubscriptions: Bool)?
  open var threadsEnabledEnabledThreadSubscriptionsReceivedInvocations:
    [(enabled: Bool, threadSubscriptions: Bool)] = []
  ...
  open override func threadsEnabled(enabled: Bool, threadSubscriptions: Bool) -> ClientBuilder {
    ...
    threadsEnabledEnabledThreadSubscriptionsReceivedArguments = (
      enabled: enabled, threadSubscriptions: threadSubscriptions
    )
    DispatchQueue.main.async {
      self.threadsEnabledEnabledThreadSubscriptionsReceivedInvocations.append(
        (enabled: enabled, threadSubscriptions: threadSubscriptions))
    }
    if let threadsEnabledEnabledThreadSubscriptionsClosure =
      threadsEnabledEnabledThreadSubscriptionsClosure
    {
  ...
  open var withSearchIndexStorePathPasswordReceivedInvocations:
  ...
  open override func withSearchIndexStore(path: String, password: String?) -> ClientBuilder {
    ...
    DispatchQueue.main.async {
      self.withSearchIndexStorePathPasswordReceivedInvocations.append(
...
open class EncryptionSDKMock: MatrixRustSDK.Encryption, @unchecked Sendable {
  ...
  open var enableRecoveryWaitForBackupsToUploadPassphraseProgressListenerCallsCount: Int {
    get {
      if Thread.isMainThread {
        ...
        DispatchQueue.main.sync {
          returnValue =
            enableRecoveryWaitForBackupsToUploadPassphraseProgressListenerUnderlyingCallsCount
        }
  ...
  open var enableRecoveryWaitForBackupsToUploadPassphraseProgressListenerReceivedArguments:
    (
      waitForBackupsToUpload: Bool, passphrase: String?,
      progressListener: EnableRecoveryProgressListener
    )?
  open var enableRecoveryWaitForBackupsToUploadPassphraseProgressListenerReceivedInvocations:
    [(
      waitForBackupsToUpload: Bool, passphrase: String?,
      progressListener: EnableRecoveryProgressListener
    )] = []

  open var enableRecoveryWaitForBackupsToUploadPassphraseProgressListenerUnderlyingReturnValue:
    String!
  ...
  open var enableRecoveryWaitForBackupsToUploadPassphraseProgressListenerClosure:
    ((Bool, String?, EnableRecoveryProgressListener) async throws -> String)?

  open override func enableRecovery(
    waitForBackupsToUpload: Bool, passphrase: String?,
    progressListener: EnableRecoveryProgressListener
  ) async throws -> String {
    ...
    enableRecoveryWaitForBackupsToUploadPassphraseProgressListenerReceivedArguments = (
      waitForBackupsToUpload: waitForBackupsToUpload, passphrase: passphrase,
      progressListener: progressListener
    )
    DispatchQueue.main.async {
      self.enableRecoveryWaitForBackupsToUploadPassphraseProgressListenerReceivedInvocations.append(
        (
          waitForBackupsToUpload: waitForBackupsToUpload, passphrase: passphrase,
          progressListener: progressListener
        ))
    }
    if let enableRecoveryWaitForBackupsToUploadPassphraseProgressListenerClosure =
      enableRecoveryWaitForBackupsToUploadPassphraseProgressListenerClosure
    {
      return try await enableRecoveryWaitForBackupsToUploadPassphraseProgressListenerClosure(
        waitForBackupsToUpload, passphrase, progressListener)
    } else {
  ...
  open var importSecretsBundleSecretsBundleClosure:
    ((SecretsBundleWithUserId) async throws -> Void)?
  ...
  open var userIdentityUserIdFallbackToServerReceivedArguments:
    (userId: String, fallbackToServer: Bool)?
  open var userIdentityUserIdFallbackToServerReceivedInvocations:
    [(userId: String, fallbackToServer: Bool)] = []
  ...
  open var userIdentityUserIdFallbackToServerClosure:
    ((String, Bool) async throws -> UserIdentity?)?

  open override func userIdentity(userId: String, fallbackToServer: Bool) async throws
    -> UserIdentity?
  {
    ...
    userIdentityUserIdFallbackToServerReceivedArguments = (
      userId: userId, fallbackToServer: fallbackToServer
    )
    DispatchQueue.main.async {
      self.userIdentityUserIdFallbackToServerReceivedInvocations.append(
        (userId: userId, fallbackToServer: fallbackToServer))
    }
  ...
  open var waitForBackupUploadSteadyStateProgressListenerReceivedProgressListener:
    BackupSteadyStateListener?
  open var waitForBackupUploadSteadyStateProgressListenerReceivedInvocations:
    [BackupSteadyStateListener?] = []
  open var waitForBackupUploadSteadyStateProgressListenerClosure:
    ((BackupSteadyStateListener?) async throws -> Void)?

  open override func waitForBackupUploadSteadyState(progressListener: BackupSteadyStateListener?)
    async throws
  {
    ...
    DispatchQueue.main.async {
      self.waitForBackupUploadSteadyStateProgressListenerReceivedInvocations.append(
        progressListener)
    }
...
open class GrantLoginWithQrCodeHandlerSDKMock: MatrixRustSDK.GrantLoginWithQrCodeHandler,
  @unchecked Sendable
{
  public init() {
    super.init(noHandle: .init())
  ...
  open var generateProgressListenerClosure:
    ((GrantGeneratedQrLoginProgressListener) async throws -> Void)?
  ...
  open var scanQrCodeDataProgressListenerReceivedArguments:
    (qrCodeData: QrCodeData, progressListener: GrantQrLoginProgressListener)?
  open var scanQrCodeDataProgressListenerReceivedInvocations:
    [(qrCodeData: QrCodeData, progressListener: GrantQrLoginProgressListener)] = []
  open var scanQrCodeDataProgressListenerClosure:
    ((QrCodeData, GrantQrLoginProgressListener) async throws -> Void)?

  open override func scan(qrCodeData: QrCodeData, progressListener: GrantQrLoginProgressListener)
    async throws
  {
    ...
    scanQrCodeDataProgressListenerReceivedArguments = (
      qrCodeData: qrCodeData, progressListener: progressListener
    )
    DispatchQueue.main.async {
      self.scanQrCodeDataProgressListenerReceivedInvocations.append(
        (qrCodeData: qrCodeData, progressListener: progressListener))
    }
...
open class LoginWithQrCodeHandlerSDKMock: MatrixRustSDK.LoginWithQrCodeHandler, @unchecked Sendable
{
  ...
  open var generateProgressListenerClosure:
    ((GeneratedQrLoginProgressListener) async throws -> Void)?
  ...
  open var scanQrCodeDataProgressListenerReceivedArguments:
    (qrCodeData: QrCodeData, progressListener: QrLoginProgressListener)?
  open var scanQrCodeDataProgressListenerReceivedInvocations:
    [(qrCodeData: QrCodeData, progressListener: QrLoginProgressListener)] = []
  open var scanQrCodeDataProgressListenerClosure:
    ((QrCodeData, QrLoginProgressListener) async throws -> Void)?

  open override func scan(qrCodeData: QrCodeData, progressListener: QrLoginProgressListener)
    async throws
  {
    if let error = scanQrCodeDataProgressListenerThrowableError {
      throw error
...
open class NotificationClientSDKMock: MatrixRustSDK.NotificationClient, @unchecked Sendable {
  ...
  open var getNotificationRoomIdEventIdClosure:
    ((String, String) async throws -> NotificationStatus)?

  open override func getNotification(roomId: String, eventId: String) async throws
    -> NotificationStatus
  {
    ...
    DispatchQueue.main.async {
      self.getNotificationRoomIdEventIdReceivedInvocations.append(
  ...
  open var getNotificationsRequestsClosure:
    (([NotificationItemsRequest]) async throws -> [String: BatchNotificationResult])?

  open override func getNotifications(requests: [NotificationItemsRequest]) async throws -> [String:
...
open class NotificationSettingsSDKMock: MatrixRustSDK.NotificationSettings, @unchecked Sendable {
  ...
  open override func canHomeserverPushEncryptedEventToDevice() async -> Bool {
    ...
    if let canHomeserverPushEncryptedEventToDeviceClosure =
      canHomeserverPushEncryptedEventToDeviceClosure
    {
  ...
  open var getDefaultRoomNotificationModeIsEncryptedIsOneToOneReceivedArguments:
    (isEncrypted: Bool, isOneToOne: Bool)?
  open var getDefaultRoomNotificationModeIsEncryptedIsOneToOneReceivedInvocations:
    [(isEncrypted: Bool, isOneToOne: Bool)] = []

  open var getDefaultRoomNotificationModeIsEncryptedIsOneToOneUnderlyingReturnValue:
  ...
  open var getDefaultRoomNotificationModeIsEncryptedIsOneToOneClosure:
    ((Bool, Bool) async -> RoomNotificationMode)?

  open override func getDefaultRoomNotificationMode(isEncrypted: Bool, isOneToOne: Bool) async
    -> RoomNotificationMode
  {
    getDefaultRoomNotificationModeIsEncryptedIsOneToOneCallsCount += 1
    getDefaultRoomNotificationModeIsEncryptedIsOneToOneReceivedArguments = (
      isEncrypted: isEncrypted, isOneToOne: isOneToOne
    )
    DispatchQueue.main.async {
      self.getDefaultRoomNotificationModeIsEncryptedIsOneToOneReceivedInvocations.append(
        (isEncrypted: isEncrypted, isOneToOne: isOneToOne))
    }
    if let getDefaultRoomNotificationModeIsEncryptedIsOneToOneClosure =
      getDefaultRoomNotificationModeIsEncryptedIsOneToOneClosure
    {
      return await getDefaultRoomNotificationModeIsEncryptedIsOneToOneClosure(
        isEncrypted, isOneToOne)
    } else {
  ...
  open var getRoomNotificationSettingsRoomIdIsEncryptedIsOneToOneReceivedArguments:
    (roomId: String, isEncrypted: Bool, isOneToOne: Bool)?
  open var getRoomNotificationSettingsRoomIdIsEncryptedIsOneToOneReceivedInvocations:
    [(roomId: String, isEncrypted: Bool, isOneToOne: Bool)] = []

  open var getRoomNotificationSettingsRoomIdIsEncryptedIsOneToOneUnderlyingReturnValue:
    RoomNotificationSettings!
  open var getRoomNotificationSettingsRoomIdIsEncryptedIsOneToOneReturnValue:
    RoomNotificationSettings!
  {
    get {
      if Thread.isMainThread {
  ...
  open var getRoomNotificationSettingsRoomIdIsEncryptedIsOneToOneClosure:
    ((String, Bool, Bool) async throws -> RoomNotificationSettings)?

  open override func getRoomNotificationSettings(
    roomId: String, isEncrypted: Bool, isOneToOne: Bool
    ...
    getRoomNotificationSettingsRoomIdIsEncryptedIsOneToOneReceivedArguments = (
      roomId: roomId, isEncrypted: isEncrypted, isOneToOne: isOneToOne
    )
    DispatchQueue.main.async {
      self.getRoomNotificationSettingsRoomIdIsEncryptedIsOneToOneReceivedInvocations.append(
        (roomId: roomId, isEncrypted: isEncrypted, isOneToOne: isOneToOne))
    }
    if let getRoomNotificationSettingsRoomIdIsEncryptedIsOneToOneClosure =
      getRoomNotificationSettingsRoomIdIsEncryptedIsOneToOneClosure
    {
      return try await getRoomNotificationSettingsRoomIdIsEncryptedIsOneToOneClosure(
        roomId, isEncrypted, isOneToOne)
    } else {
  ...
  open var getUserDefinedRoomNotificationModeRoomIdClosure:
    ((String) async throws -> RoomNotificationMode?)?

  open override func getUserDefinedRoomNotificationMode(roomId: String) async throws
    -> RoomNotificationMode?
  {
    ...
    if let getUserDefinedRoomNotificationModeRoomIdClosure =
      getUserDefinedRoomNotificationModeRoomIdClosure
    {
  ...
  open var setCustomPushRuleRuleIdRuleKindActionsConditionsReceivedArguments:
    (ruleId: String, ruleKind: RuleKind, actions: [Action], conditions: [PushCondition])?
  open var setCustomPushRuleRuleIdRuleKindActionsConditionsReceivedInvocations:
    [(ruleId: String, ruleKind: RuleKind, actions: [Action], conditions: [PushCondition])] = []
  open var setCustomPushRuleRuleIdRuleKindActionsConditionsClosure:
    ((String, RuleKind, [Action], [PushCondition]) async throws -> Void)?

  open override func setCustomPushRule(
    ruleId: String, ruleKind: RuleKind, actions: [Action], conditions: [PushCondition]
  ) async throws {
    ...
    setCustomPushRuleRuleIdRuleKindActionsConditionsReceivedArguments = (
      ruleId: ruleId, ruleKind: ruleKind, actions: actions, conditions: conditions
    )
    DispatchQueue.main.async {
      self.setCustomPushRuleRuleIdRuleKindActionsConditionsReceivedInvocations.append(
        (ruleId: ruleId, ruleKind: ruleKind, actions: actions, conditions: conditions))
    }
    try await setCustomPushRuleRuleIdRuleKindActionsConditionsClosure?(
  ...
  open var setDefaultRoomNotificationModeIsEncryptedIsOneToOneModeReceivedArguments:
    (isEncrypted: Bool, isOneToOne: Bool, mode: RoomNotificationMode)?
  open var setDefaultRoomNotificationModeIsEncryptedIsOneToOneModeReceivedInvocations:
    [(isEncrypted: Bool, isOneToOne: Bool, mode: RoomNotificationMode)] = []
  open var setDefaultRoomNotificationModeIsEncryptedIsOneToOneModeClosure:
    ((Bool, Bool, RoomNotificationMode) async throws -> Void)?

  open override func setDefaultRoomNotificationMode(
    isEncrypted: Bool, isOneToOne: Bool, mode: RoomNotificationMode
  ) async throws {
    ...
    setDefaultRoomNotificationModeIsEncryptedIsOneToOneModeReceivedArguments = (
      isEncrypted: isEncrypted, isOneToOne: isOneToOne, mode: mode
    )
    DispatchQueue.main.async {
      self.setDefaultRoomNotificationModeIsEncryptedIsOneToOneModeReceivedInvocations.append(
        (isEncrypted: isEncrypted, isOneToOne: isOneToOne, mode: mode))
    }
    try await setDefaultRoomNotificationModeIsEncryptedIsOneToOneModeClosure?(
      isEncrypted, isOneToOne, mode)
  }
  ...
  open var setRoomNotificationModeRoomIdModeReceivedArguments:
    (roomId: String, mode: RoomNotificationMode)?
  open var setRoomNotificationModeRoomIdModeReceivedInvocations:
    [(roomId: String, mode: RoomNotificationMode)] = []
  open var setRoomNotificationModeRoomIdModeClosure:
    ((String, RoomNotificationMode) async throws -> Void)?

  open override func setRoomNotificationMode(roomId: String, mode: RoomNotificationMode)
    async throws
  {
  ...
  open var unmuteRoomRoomIdIsEncryptedIsOneToOneReceivedArguments:
    (roomId: String, isEncrypted: Bool, isOneToOne: Bool)?
  open var unmuteRoomRoomIdIsEncryptedIsOneToOneReceivedInvocations:
    [(roomId: String, isEncrypted: Bool, isOneToOne: Bool)] = []
  open var unmuteRoomRoomIdIsEncryptedIsOneToOneClosure:
    ((String, Bool, Bool) async throws -> Void)?
  ...
  open override func unmuteRoom(roomId: String, isEncrypted: Bool, isOneToOne: Bool) async throws {
    ...
    unmuteRoomRoomIdIsEncryptedIsOneToOneReceivedArguments = (
      roomId: roomId, isEncrypted: isEncrypted, isOneToOne: isOneToOne
    )
    DispatchQueue.main.async {
      self.unmuteRoomRoomIdIsEncryptedIsOneToOneReceivedInvocations.append(
        (roomId: roomId, isEncrypted: isEncrypted, isOneToOne: isOneToOne))
    }
...
open class RoomSDKMock: MatrixRustSDK.Room, @unchecked Sendable {
  ...
  open var editEventIdNewContentReceivedArguments:
    (eventId: String, newContent: RoomMessageEventContentWithoutRelation)?
  open var editEventIdNewContentReceivedInvocations:
    [(eventId: String, newContent: RoomMessageEventContentWithoutRelation)] = []
  open var editEventIdNewContentClosure:
    ((String, RoomMessageEventContentWithoutRelation) async throws -> Void)?

  open override func edit(eventId: String, newContent: RoomMessageEventContentWithoutRelation)
    async throws
  {
    ...
    DispatchQueue.main.async {
      self.editEventIdNewContentReceivedInvocations.append(
        (eventId: eventId, newContent: newContent))
    }
  ...
  open var fetchThreadSubscriptionThreadRootEventIdClosure:
    ((String) async throws -> ThreadSubscription?)?

  open override func fetchThreadSubscription(threadRootEventId: String) async throws
    -> ThreadSubscription?
  {
    ...
    if let fetchThreadSubscriptionThreadRootEventIdClosure =
      fetchThreadSubscriptionThreadRootEventIdClosure
    {
  ...
  open var ignoreDeviceTrustAndResendDevicesSendHandleReceivedArguments:
    (devices: [String: [String]], sendHandle: SendHandle)?
  open var ignoreDeviceTrustAndResendDevicesSendHandleReceivedInvocations:
    [(devices: [String: [String]], sendHandle: SendHandle)] = []
  open var ignoreDeviceTrustAndResendDevicesSendHandleClosure:
    (([String: [String]], SendHandle) async throws -> Void)?

  open override func ignoreDeviceTrustAndResend(devices: [String: [String]], sendHandle: SendHandle)
    async throws
  {
    ...
    ignoreDeviceTrustAndResendDevicesSendHandleReceivedArguments = (
      devices: devices, sendHandle: sendHandle
    )
    DispatchQueue.main.async {
      self.ignoreDeviceTrustAndResendDevicesSendHandleReceivedInvocations.append(
        (devices: devices, sendHandle: sendHandle))
    }
  ...
  open override func removeRoomAliasFromRoomDirectory(alias: String) async throws -> Bool {
    ...
    if let removeRoomAliasFromRoomDirectoryAliasClosure =
      removeRoomAliasFromRoomDirectoryAliasClosure
    {
  ...
  open var saveComposerDraftDraftThreadRootReceivedArguments:
    (draft: ComposerDraft, threadRoot: String?)?
  open var saveComposerDraftDraftThreadRootReceivedInvocations:
    [(draft: ComposerDraft, threadRoot: String?)] = []
  ...
  open override func saveComposerDraft(draft: ComposerDraft, threadRoot: String?) async throws {
    ...
    DispatchQueue.main.async {
      self.saveComposerDraftDraftThreadRootReceivedInvocations.append(
        (draft: draft, threadRoot: threadRoot))
    }
  ...
  open override func sendRaw(eventType: String, content: String) async throws {
    ...
    DispatchQueue.main.async {
      self.sendRawEventTypeContentReceivedInvocations.append(
        (eventType: eventType, content: content))
    }
  ...
  open var sendStateEventRawEventTypeStateKeyContentThrowableError: Error?
  open var sendStateEventRawEventTypeStateKeyContentUnderlyingCallsCount = 0
  open var sendStateEventRawEventTypeStateKeyContentCallsCount: Int {
    get {
      if Thread.isMainThread {
        return sendStateEventRawEventTypeStateKeyContentUnderlyingCallsCount
      } else {
        var returnValue: Int? = nil
        DispatchQueue.main.sync {
          returnValue = sendStateEventRawEventTypeStateKeyContentUnderlyingCallsCount
        }
    ...
    set {
      if Thread.isMainThread {
        sendStateEventRawEventTypeStateKeyContentUnderlyingCallsCount = newValue
      } else {
        DispatchQueue.main.sync {
          sendStateEventRawEventTypeStateKeyContentUnderlyingCallsCount = newValue
        }
  ...
  open var sendStateEventRawEventTypeStateKeyContentCalled: Bool {
    return sendStateEventRawEventTypeStateKeyContentCallsCount > 0
  }
  open var sendStateEventRawEventTypeStateKeyContentReceivedArguments:
    (eventType: String, stateKey: String, content: String)?
  open var sendStateEventRawEventTypeStateKeyContentReceivedInvocations:
    [(eventType: String, stateKey: String, content: String)] = []

  open var sendStateEventRawEventTypeStateKeyContentUnderlyingReturnValue: String!
  open var sendStateEventRawEventTypeStateKeyContentReturnValue: String! {
    get {
      if Thread.isMainThread {
        return sendStateEventRawEventTypeStateKeyContentUnderlyingReturnValue
      } else {
        var returnValue: String? = nil
        DispatchQueue.main.sync {
          returnValue = sendStateEventRawEventTypeStateKeyContentUnderlyingReturnValue
        }
    ...
    set {
      if Thread.isMainThread {
        sendStateEventRawEventTypeStateKeyContentUnderlyingReturnValue = newValue
      } else {
        DispatchQueue.main.sync {
          sendStateEventRawEventTypeStateKeyContentUnderlyingReturnValue = newValue
        }
  ...
  open var sendStateEventRawEventTypeStateKeyContentClosure:
    ((String, String, String) async throws -> String)?

  open override func sendStateEventRaw(eventType: String, stateKey: String, content: String)
    async throws -> String
  {
    if let error = sendStateEventRawEventTypeStateKeyContentThrowableError {
      throw error
    }
    sendStateEventRawEventTypeStateKeyContentCallsCount += 1
    sendStateEventRawEventTypeStateKeyContentReceivedArguments = (
      eventType: eventType, stateKey: stateKey, content: content
    )
    DispatchQueue.main.async {
      self.sendStateEventRawEventTypeStateKeyContentReceivedInvocations.append(
        (eventType: eventType, stateKey: stateKey, content: content))
    }
    if let sendStateEventRawEventTypeStateKeyContentClosure =
      sendStateEventRawEventTypeStateKeyContentClosure
    {
      return try await sendStateEventRawEventTypeStateKeyContentClosure(
        eventType, stateKey, content)
    } else {
      return sendStateEventRawEventTypeStateKeyContentReturnValue
    }
  }
  ...
  open var setIsFavouriteIsFavouriteTagOrderReceivedArguments:
    (isFavourite: Bool, tagOrder: Double?)?
  open var setIsFavouriteIsFavouriteTagOrderReceivedInvocations:
    [(isFavourite: Bool, tagOrder: Double?)] = []
  ...
  open override func setIsFavourite(isFavourite: Bool, tagOrder: Double?) async throws {
    ...
    setIsFavouriteIsFavouriteTagOrderReceivedArguments = (
      isFavourite: isFavourite, tagOrder: tagOrder
    )
    DispatchQueue.main.async {
      self.setIsFavouriteIsFavouriteTagOrderReceivedInvocations.append(
        (isFavourite: isFavourite, tagOrder: tagOrder))
    }
  ...
  open var setIsLowPriorityIsLowPriorityTagOrderReceivedArguments:
    (isLowPriority: Bool, tagOrder: Double?)?
  open var setIsLowPriorityIsLowPriorityTagOrderReceivedInvocations:
    [(isLowPriority: Bool, tagOrder: Double?)] = []
  ...
  open override func setIsLowPriority(isLowPriority: Bool, tagOrder: Double?) async throws {
    ...
    setIsLowPriorityIsLowPriorityTagOrderReceivedArguments = (
      isLowPriority: isLowPriority, tagOrder: tagOrder
    )
    DispatchQueue.main.async {
      self.setIsLowPriorityIsLowPriorityTagOrderReceivedInvocations.append(
        (isLowPriority: isLowPriority, tagOrder: tagOrder))
    }
  ...
  open var setThreadSubscriptionThreadRootEventIdSubscribedReceivedArguments:
    (threadRootEventId: String, subscribed: Bool)?
  open var setThreadSubscriptionThreadRootEventIdSubscribedReceivedInvocations:
    [(threadRootEventId: String, subscribed: Bool)] = []
  open var setThreadSubscriptionThreadRootEventIdSubscribedClosure:
    ((String, Bool) async throws -> Void)?
  ...
  open override func setThreadSubscription(threadRootEventId: String, subscribed: Bool) async throws
  {
    ...
    setThreadSubscriptionThreadRootEventIdSubscribedReceivedArguments = (
      threadRootEventId: threadRootEventId, subscribed: subscribed
    )
    DispatchQueue.main.async {
      self.setThreadSubscriptionThreadRootEventIdSubscribedReceivedInvocations.append(
        (threadRootEventId: threadRootEventId, subscribed: subscribed))
    }
    try await setThreadSubscriptionThreadRootEventIdSubscribedClosure?(
      threadRootEventId, subscribed)
  }
  ...
  open var subscribeToCallDeclineEventsRtcNotificationEventIdListenerCallsCount: Int {
    get {
      if Thread.isMainThread {
        ...
        DispatchQueue.main.sync {
          returnValue =
            subscribeToCallDeclineEventsRtcNotificationEventIdListenerUnderlyingCallsCount
        }
  ...
  open var subscribeToCallDeclineEventsRtcNotificationEventIdListenerReceivedArguments:
    (rtcNotificationEventId: String, listener: CallDeclineListener)?
  open var subscribeToCallDeclineEventsRtcNotificationEventIdListenerReceivedInvocations:
    [(rtcNotificationEventId: String, listener: CallDeclineListener)] = []

  open var subscribeToCallDeclineEventsRtcNotificationEventIdListenerUnderlyingReturnValue:
    TaskHandle!
  open var subscribeToCallDeclineEventsRtcNotificationEventIdListenerReturnValue: TaskHandle! {
    get {
      if Thread.isMainThread {
        ...
        DispatchQueue.main.sync {
          returnValue =
            subscribeToCallDeclineEventsRtcNotificationEventIdListenerUnderlyingReturnValue
        }
  ...
  open var subscribeToCallDeclineEventsRtcNotificationEventIdListenerClosure:
    ((String, CallDeclineListener) throws -> TaskHandle)?

  open override func subscribeToCallDeclineEvents(
    rtcNotificationEventId: String, listener: CallDeclineListener
  ) throws -> TaskHandle {
    ...
    subscribeToCallDeclineEventsRtcNotificationEventIdListenerReceivedArguments = (
      rtcNotificationEventId: rtcNotificationEventId, listener: listener
    )
    DispatchQueue.main.async {
      self.subscribeToCallDeclineEventsRtcNotificationEventIdListenerReceivedInvocations.append(
        (rtcNotificationEventId: rtcNotificationEventId, listener: listener))
    }
    if let subscribeToCallDeclineEventsRtcNotificationEventIdListenerClosure =
      subscribeToCallDeclineEventsRtcNotificationEventIdListenerClosure
    {
      return try subscribeToCallDeclineEventsRtcNotificationEventIdListenerClosure(
        rtcNotificationEventId, listener)
    } else {
  ...
  open var subscribeToIdentityStatusChangesListenerReceivedInvocations:
    [IdentityStatusChangeListener] = []
  ...
  open var subscribeToIdentityStatusChangesListenerClosure:
    ((IdentityStatusChangeListener) async throws -> TaskHandle)?

  open override func subscribeToIdentityStatusChanges(listener: IdentityStatusChangeListener)
    async throws -> TaskHandle
  {
    ...
    if let subscribeToIdentityStatusChangesListenerClosure =
      subscribeToIdentityStatusChangesListenerClosure
    {
  ...
  open var subscribeToKnockRequestsListenerClosure:
    ((KnockRequestsListener) async throws -> TaskHandle)?

  open override func subscribeToKnockRequests(listener: KnockRequestsListener) async throws
    -> TaskHandle
  {
  ...
  open var subscribeToSendQueueUpdatesListenerClosure:
    ((SendQueueListener) async throws -> TaskHandle)?

  open override func subscribeToSendQueueUpdates(listener: SendQueueListener) async throws
    -> TaskHandle
  {
    if let error = subscribeToSendQueueUpdatesListenerThrowableError {
      throw error
  ...
  open var subscribeToTypingNotificationsListenerReceivedInvocations:
  ...
  open var subscribeToTypingNotificationsListenerClosure:
    ((TypingNotificationsListener) -> TaskHandle)?

  open override func subscribeToTypingNotifications(listener: TypingNotificationsListener)
    -> TaskHandle
  {
    ...
    if let subscribeToTypingNotificationsListenerClosure =
      subscribeToTypingNotificationsListenerClosure
    {
  ...
  open var threadListServiceUnderlyingCallsCount = 0
  open var threadListServiceCallsCount: Int {
    get {
      if Thread.isMainThread {
  ...
  open var threadListServiceCalled: Bool {
    return threadListServiceCallsCount > 0
  }

  open var threadListServiceUnderlyingReturnValue: ThreadListService!
  open var threadListServiceReturnValue: ThreadListService! {
    get {
      if Thread.isMainThread {
        return threadListServiceUnderlyingReturnValue
      } else {
        var returnValue: ThreadListService? = nil
        DispatchQueue.main.sync {
  ...
  open var threadListServiceClosure: (() -> ThreadListService)?

  open override func threadListService() -> ThreadListService {
  ...
  open var timelineWithConfigurationConfigurationClosure:
    ((TimelineConfiguration) async throws -> Timeline)?

  open override func timelineWithConfiguration(configuration: TimelineConfiguration) async throws
    -> Timeline
  {
    ...
    if let timelineWithConfigurationConfigurationClosure =
      timelineWithConfigurationConfigurationClosure
    {
  ...
  open var updateCanonicalAliasAliasAltAliasesReceivedArguments:
    (alias: String?, altAliases: [String])?
  open var updateCanonicalAliasAliasAltAliasesReceivedInvocations:
    [(alias: String?, altAliases: [String])] = []
  ...
  open override func updateCanonicalAlias(alias: String?, altAliases: [String]) async throws {
    ...
    DispatchQueue.main.async {
      self.updateCanonicalAliasAliasAltAliasesReceivedInvocations.append(
        (alias: alias, altAliases: altAliases))
    }
  ...
  open var uploadAvatarMimeTypeDataMediaInfoReceivedArguments:
    (mimeType: String, data: Data, mediaInfo: ImageInfo?)?
  open var uploadAvatarMimeTypeDataMediaInfoReceivedInvocations:
    [(mimeType: String, data: Data, mediaInfo: ImageInfo?)] = []
  open var uploadAvatarMimeTypeDataMediaInfoClosure:
    ((String, Data, ImageInfo?) async throws -> Void)?
  ...
  open override func uploadAvatar(mimeType: String, data: Data, mediaInfo: ImageInfo?) async throws
  {
    ...
    uploadAvatarMimeTypeDataMediaInfoReceivedArguments = (
      mimeType: mimeType, data: data, mediaInfo: mediaInfo
    )
    DispatchQueue.main.async {
      self.uploadAvatarMimeTypeDataMediaInfoReceivedInvocations.append(
        (mimeType: mimeType, data: data, mediaInfo: mediaInfo))
    }
  ...
  open var withdrawVerificationAndResendUserIdsSendHandleReceivedArguments:
    (userIds: [String], sendHandle: SendHandle)?
  open var withdrawVerificationAndResendUserIdsSendHandleReceivedInvocations:
    [(userIds: [String], sendHandle: SendHandle)] = []
  open var withdrawVerificationAndResendUserIdsSendHandleClosure:
    (([String], SendHandle) async throws -> Void)?

  open override func withdrawVerificationAndResend(userIds: [String], sendHandle: SendHandle)
    async throws
  {
    ...
    withdrawVerificationAndResendUserIdsSendHandleReceivedArguments = (
      userIds: userIds, sendHandle: sendHandle
    )
    DispatchQueue.main.async {
      self.withdrawVerificationAndResendUserIdsSendHandleReceivedInvocations.append(
        (userIds: userIds, sendHandle: sendHandle))
    }
  ...
  open var searchMessagesQueryNumResultsPerBatchReceivedArguments:
    (query: String, numResultsPerBatch: UInt32)?
  open var searchMessagesQueryNumResultsPerBatchReceivedInvocations:
    [(query: String, numResultsPerBatch: UInt32)] = []
  ...
  open override func searchMessages(query: String, numResultsPerBatch: UInt32) -> RoomSearchIterator
  {
    ...
    searchMessagesQueryNumResultsPerBatchReceivedArguments = (
      query: query, numResultsPerBatch: numResultsPerBatch
    )
    DispatchQueue.main.async {
      self.searchMessagesQueryNumResultsPerBatchReceivedInvocations.append(
        (query: query, numResultsPerBatch: numResultsPerBatch))
    }
    if let searchMessagesQueryNumResultsPerBatchClosure =
      searchMessagesQueryNumResultsPerBatchClosure
    {
...
open class RoomDirectorySearchSDKMock: MatrixRustSDK.RoomDirectorySearch, @unchecked Sendable {
  ...
  open var searchFilterBatchSizeViaServerNameReceivedArguments:
    (filter: String?, batchSize: UInt32, viaServerName: String?)?
  open var searchFilterBatchSizeViaServerNameReceivedInvocations:
    [(filter: String?, batchSize: UInt32, viaServerName: String?)] = []
  open var searchFilterBatchSizeViaServerNameClosure:
    ((String?, UInt32, String?) async throws -> Void)?
  ...
  open override func search(filter: String?, batchSize: UInt32, viaServerName: String?) async throws
  {
    ...
    searchFilterBatchSizeViaServerNameReceivedArguments = (
      filter: filter, batchSize: batchSize, viaServerName: viaServerName
    )
    DispatchQueue.main.async {
      self.searchFilterBatchSizeViaServerNameReceivedInvocations.append(
        (filter: filter, batchSize: batchSize, viaServerName: viaServerName))
    }
...
open class RoomListSDKMock: MatrixRustSDK.RoomList, @unchecked Sendable {
  ...
  open var entriesWithDynamicAdaptersPageSizeListenerReceivedArguments:
    (pageSize: UInt32, listener: RoomListEntriesListener)?
  open var entriesWithDynamicAdaptersPageSizeListenerReceivedInvocations:
    [(pageSize: UInt32, listener: RoomListEntriesListener)] = []

  open var entriesWithDynamicAdaptersPageSizeListenerUnderlyingReturnValue:
    RoomListEntriesWithDynamicAdaptersResult!
  open var entriesWithDynamicAdaptersPageSizeListenerReturnValue:
    RoomListEntriesWithDynamicAdaptersResult!
  {
    get {
      if Thread.isMainThread {
  ...
  open var entriesWithDynamicAdaptersPageSizeListenerClosure:
    ((UInt32, RoomListEntriesListener) -> RoomListEntriesWithDynamicAdaptersResult)?

  open override func entriesWithDynamicAdapters(pageSize: UInt32, listener: RoomListEntriesListener)
    -> RoomListEntriesWithDynamicAdaptersResult
  {
    entriesWithDynamicAdaptersPageSizeListenerCallsCount += 1
    entriesWithDynamicAdaptersPageSizeListenerReceivedArguments = (
      pageSize: pageSize, listener: listener
    )
    DispatchQueue.main.async {
      self.entriesWithDynamicAdaptersPageSizeListenerReceivedInvocations.append(
        (pageSize: pageSize, listener: listener))
    }
    if let entriesWithDynamicAdaptersPageSizeListenerClosure =
      entriesWithDynamicAdaptersPageSizeListenerClosure
    {
  ...
  open var loadingStateListenerClosure:
    ((RoomListLoadingStateListener) throws -> RoomListLoadingStateResult)?

  open override func loadingState(listener: RoomListLoadingStateListener) throws
...
open class RoomListEntriesWithDynamicAdaptersResultSDKMock: MatrixRustSDK
    .RoomListEntriesWithDynamicAdaptersResult, @unchecked Sendable
{
  public init() {
    super.init(noHandle: .init())
  }
...
open class RoomListServiceSDKMock: MatrixRustSDK.RoomListService, @unchecked Sendable {
  ...
  open var syncIndicatorDelayBeforeShowingInMsDelayBeforeHidingInMsListenerReceivedArguments:
    (
      delayBeforeShowingInMs: UInt32, delayBeforeHidingInMs: UInt32,
      listener: RoomListServiceSyncIndicatorListener
    )?
  open var syncIndicatorDelayBeforeShowingInMsDelayBeforeHidingInMsListenerReceivedInvocations:
    [(
      delayBeforeShowingInMs: UInt32, delayBeforeHidingInMs: UInt32,
      listener: RoomListServiceSyncIndicatorListener
    )] = []

  open var syncIndicatorDelayBeforeShowingInMsDelayBeforeHidingInMsListenerUnderlyingReturnValue:
    TaskHandle!
  open var syncIndicatorDelayBeforeShowingInMsDelayBeforeHidingInMsListenerReturnValue: TaskHandle!
  {
    get {
      if Thread.isMainThread {
        ...
        DispatchQueue.main.sync {
          returnValue =
            syncIndicatorDelayBeforeShowingInMsDelayBeforeHidingInMsListenerUnderlyingReturnValue
        }
  ...
  open var syncIndicatorDelayBeforeShowingInMsDelayBeforeHidingInMsListenerClosure:
    ((UInt32, UInt32, RoomListServiceSyncIndicatorListener) -> TaskHandle)?

  open override func syncIndicator(
    delayBeforeShowingInMs: UInt32, delayBeforeHidingInMs: UInt32,
    listener: RoomListServiceSyncIndicatorListener
  ) -> TaskHandle {
    syncIndicatorDelayBeforeShowingInMsDelayBeforeHidingInMsListenerCallsCount += 1
    syncIndicatorDelayBeforeShowingInMsDelayBeforeHidingInMsListenerReceivedArguments = (
      delayBeforeShowingInMs: delayBeforeShowingInMs, delayBeforeHidingInMs: delayBeforeHidingInMs,
      listener: listener
    )
    DispatchQueue.main.async {
      self.syncIndicatorDelayBeforeShowingInMsDelayBeforeHidingInMsListenerReceivedInvocations
        .append(
          (
            delayBeforeShowingInMs: delayBeforeShowingInMs,
            delayBeforeHidingInMs: delayBeforeHidingInMs, listener: listener
          ))
    }
    if let syncIndicatorDelayBeforeShowingInMsDelayBeforeHidingInMsListenerClosure =
      syncIndicatorDelayBeforeShowingInMsDelayBeforeHidingInMsListenerClosure
    {
      return syncIndicatorDelayBeforeShowingInMsDelayBeforeHidingInMsListenerClosure(
        delayBeforeShowingInMs, delayBeforeHidingInMs, listener)
    } else {
...
open class RoomMessageEventContentWithoutRelationSDKMock: MatrixRustSDK
    .RoomMessageEventContentWithoutRelation, @unchecked Sendable
{
  public init() {
    super.init(noHandle: .init())
  }
...
open class RoomPowerLevelsSDKMock: MatrixRustSDK.RoomPowerLevels, @unchecked Sendable {
  ...
  open var canUserSendMessageUserIdMessageReceivedArguments:
    (userId: String, message: MessageLikeEventType)?
  open var canUserSendMessageUserIdMessageReceivedInvocations:
    [(userId: String, message: MessageLikeEventType)] = []
  ...
  open override func canUserSendMessage(userId: String, message: MessageLikeEventType) throws
    -> Bool
  {
    ...
    DispatchQueue.main.async {
      self.canUserSendMessageUserIdMessageReceivedInvocations.append(
  ...
  open var canUserSendStateUserIdStateEventReceivedArguments:
    (userId: String, stateEvent: StateEventType)?
  open var canUserSendStateUserIdStateEventReceivedInvocations:
    [(userId: String, stateEvent: StateEventType)] = []
  ...
  open override func canUserSendState(userId: String, stateEvent: StateEventType) throws -> Bool {
    ...
    DispatchQueue.main.async {
      self.canUserSendStateUserIdStateEventReceivedInvocations.append(
        (userId: userId, stateEvent: stateEvent))
    }
  ...
  @unchecked Sendable
{
  ...
  open var acknowledgeVerificationRequestSenderIdFlowIdReceivedArguments:
    (senderId: String, flowId: String)?
  open var acknowledgeVerificationRequestSenderIdFlowIdReceivedInvocations:
    [(senderId: String, flowId: String)] = []
  open var acknowledgeVerificationRequestSenderIdFlowIdClosure:
  ...
  open override func acknowledgeVerificationRequest(senderId: String, flowId: String) async throws {
    ...
    acknowledgeVerificationRequestSenderIdFlowIdReceivedArguments = (
      senderId: senderId, flowId: flowId
    )
    DispatchQueue.main.async {
      self.acknowledgeVerificationRequestSenderIdFlowIdReceivedInvocations.append(
        (senderId: senderId, flowId: flowId))
    }
...
open class SpaceRoomListSDKMock: MatrixRustSDK.SpaceRoomList, @unchecked Sendable {
  ...
  open var subscribeToPaginationStateUpdatesListenerReceivedListener:
    SpaceRoomListPaginationStateListener?
  open var subscribeToPaginationStateUpdatesListenerReceivedInvocations:
    [SpaceRoomListPaginationStateListener] = []
  ...
  open var subscribeToPaginationStateUpdatesListenerClosure:
    ((SpaceRoomListPaginationStateListener) -> TaskHandle)?

  open override func subscribeToPaginationStateUpdates(
    listener: SpaceRoomListPaginationStateListener
  ) -> TaskHandle {
    ...
    if let subscribeToPaginationStateUpdatesListenerClosure =
      subscribeToPaginationStateUpdatesListenerClosure
    {
...
open class SpaceServiceSDKMock: MatrixRustSDK.SpaceService, @unchecked Sendable {
  ...
  open override func addChildToSpace(childId: String, spaceId: String) async throws {
    ...
    DispatchQueue.main.async {
      self.addChildToSpaceChildIdSpaceIdReceivedInvocations.append(
        (childId: childId, spaceId: spaceId))
    }
  ...
  open var removeChildFromSpaceChildIdSpaceIdReceivedInvocations:
    [(childId: String, spaceId: String)] = []
  ...
  open override func removeChildFromSpace(childId: String, spaceId: String) async throws {
    ...
    DispatchQueue.main.async {
      self.removeChildFromSpaceChildIdSpaceIdReceivedInvocations.append(
        (childId: childId, spaceId: spaceId))
    }
  ...
  open var subscribeToSpaceFiltersListenerClosure:
    ((SpaceServiceSpaceFiltersListener) async -> TaskHandle)?

  open override func subscribeToSpaceFilters(listener: SpaceServiceSpaceFiltersListener) async
    -> TaskHandle
  {
  ...
  open var subscribeToTopLevelJoinedSpacesListenerReceivedListener:
    SpaceServiceJoinedSpacesListener?
  open var subscribeToTopLevelJoinedSpacesListenerReceivedInvocations:
    [SpaceServiceJoinedSpacesListener] = []
  ...
  open var subscribeToTopLevelJoinedSpacesListenerClosure:
    ((SpaceServiceJoinedSpacesListener) async -> TaskHandle)?

  open override func subscribeToTopLevelJoinedSpaces(listener: SpaceServiceJoinedSpacesListener)
    async -> TaskHandle
  {
    ...
    if let subscribeToTopLevelJoinedSpacesListenerClosure =
      subscribeToTopLevelJoinedSpacesListenerClosure
    {
...
open class ThreadListServiceSDKMock: MatrixRustSDK.ThreadListService, @unchecked Sendable {
  public init() {
    super.init(noHandle: .init())
  }
  ...
  open var itemsUnderlyingCallsCount = 0
  open var itemsCallsCount: Int {
    get {
      if Thread.isMainThread {
        return itemsUnderlyingCallsCount
      } else {
        var returnValue: Int? = nil
        DispatchQueue.main.sync {
          returnValue = itemsUnderlyingCallsCount
        }
    ...
    set {
      if Thread.isMainThread {
        itemsUnderlyingCallsCount = newValue
      } else {
        DispatchQueue.main.sync {
          itemsUnderlyingCallsCount = newValue
        }
  ...
  open var itemsCalled: Bool {
    return itemsCallsCount > 0
  }

  open var itemsUnderlyingReturnValue: [ThreadListItem]!
  open var itemsReturnValue: [ThreadListItem]! {
    get {
      if Thread.isMainThread {
        return itemsUnderlyingReturnValue
      } else {
        var returnValue: [ThreadListItem]? = nil
        DispatchQueue.main.sync {
          returnValue = itemsUnderlyingReturnValue
        }
    ...
    set {
      if Thread.isMainThread {
        itemsUnderlyingReturnValue = newValue
      } else {
        DispatchQueue.main.sync {
          itemsUnderlyingReturnValue = newValue
        }
  ...
  open var itemsClosure: (() -> [ThreadListItem])?

  open override func items() -> [ThreadListItem] {
    itemsCallsCount += 1
    if let itemsClosure = itemsClosure {
      return itemsClosure()
    } else {
  ...
  open var paginationStateUnderlyingReturnValue: ThreadListPaginationState!
  open var paginationStateReturnValue: ThreadListPaginationState! {
    get {
      if Thread.isMainThread {
        return paginationStateUnderlyingReturnValue
      } else {
        var returnValue: ThreadListPaginationState? = nil
        DispatchQueue.main.sync {
          returnValue = paginationStateUnderlyingReturnValue
        }
  ...
  open var paginationStateClosure: (() -> ThreadListPaginationState)?

  open override func paginationState() -> ThreadListPaginationState {
    paginationStateCallsCount += 1
    if let paginationStateClosure = paginationStateClosure {
      return paginationStateClosure()
    } else {
  ...
  //MARK: - subscribeToItemsUpdates

  open var subscribeToItemsUpdatesListenerUnderlyingCallsCount = 0
  open var subscribeToItemsUpdatesListenerCallsCount: Int {
    get {
      if Thread.isMainThread {
        return subscribeToItemsUpdatesListenerUnderlyingCallsCount
      } else {
        var returnValue: Int? = nil
        DispatchQueue.main.sync {
          returnValue = subscribeToItemsUpdatesListenerUnderlyingCallsCount
        }
    ...
    set {
      if Thread.isMainThread {
        subscribeToItemsUpdatesListenerUnderlyingCallsCount = newValue
      } else {
        DispatchQueue.main.sync {
          subscribeToItemsUpdatesListenerUnderlyingCallsCount = newValue
        }
  ...
  open var subscribeToItemsUpdatesListenerCalled: Bool {
    return subscribeToItemsUpdatesListenerCallsCount > 0
  }
  open var subscribeToItemsUpdatesListenerReceivedListener: ThreadListEntriesListener?
  open var subscribeToItemsUpdatesListenerReceivedInvocations: [ThreadListEntriesListener] = []

  open var subscribeToItemsUpdatesListenerUnderlyingReturnValue: TaskHandle!
  open var subscribeToItemsUpdatesListenerReturnValue: TaskHandle! {
    get {
      if Thread.isMainThread {
        return subscribeToItemsUpdatesListenerUnderlyingReturnValue
      } else {
        var returnValue: TaskHandle? = nil
        DispatchQueue.main.sync {
          returnValue = subscribeToItemsUpdatesListenerUnderlyingReturnValue
        }
    ...
    set {
      if Thread.isMainThread {
        subscribeToItemsUpdatesListenerUnderlyingReturnValue = newValue
      } else {
        DispatchQueue.main.sync {
          subscribeToItemsUpdatesListenerUnderlyingReturnValue = newValue
        }
  ...
  open var subscribeToItemsUpdatesListenerClosure: ((ThreadListEntriesListener) -> TaskHandle)?

  open override func subscribeToItemsUpdates(listener: ThreadListEntriesListener) -> TaskHandle {
    subscribeToItemsUpdatesListenerCallsCount += 1
    subscribeToItemsUpdatesListenerReceivedListener = listener
    DispatchQueue.main.async {
      self.subscribeToItemsUpdatesListenerReceivedInvocations.append(listener)
    }
    if let subscribeToItemsUpdatesListenerClosure = subscribeToItemsUpdatesListenerClosure {
      return subscribeToItemsUpdatesListenerClosure(listener)
    } else {
      return subscribeToItemsUpdatesListenerReturnValue
    }
  }
  ...
  open var subscribeToPaginationStateUpdatesListenerClosure:
    ((ThreadListPaginationStateListener) -> TaskHandle)?

  open override func subscribeToPaginationStateUpdates(listener: ThreadListPaginationStateListener)
    -> TaskHandle
  {
    subscribeToPaginationStateUpdatesListenerCallsCount += 1
    subscribeToPaginationStateUpdatesListenerReceivedListener = listener
...
open class TimelineSDKMock: MatrixRustSDK.Timeline, @unchecked Sendable {
  ...
  open var createMessageContentMsgTypeClosure:
    ((MessageType) -> RoomMessageEventContentWithoutRelation?)?

  open override func createMessageContent(msgType: MessageType)
  ...
  open var createPollQuestionAnswersMaxSelectionsPollKindReceivedArguments:
    (question: String, answers: [String], maxSelections: UInt8, pollKind: PollKind)?
  open var createPollQuestionAnswersMaxSelectionsPollKindReceivedInvocations:
    [(question: String, answers: [String], maxSelections: UInt8, pollKind: PollKind)] = []
  open var createPollQuestionAnswersMaxSelectionsPollKindClosure:
    ((String, [String], UInt8, PollKind) async throws -> Void)?

  open override func createPoll(
    question: String, answers: [String], maxSelections: UInt8, pollKind: PollKind
  ) async throws {
    ...
    createPollQuestionAnswersMaxSelectionsPollKindReceivedArguments = (
      question: question, answers: answers, maxSelections: maxSelections, pollKind: pollKind
    )
    DispatchQueue.main.async {
      self.createPollQuestionAnswersMaxSelectionsPollKindReceivedInvocations.append(
        (question: question, answers: answers, maxSelections: maxSelections, pollKind: pollKind))
    }
    try await createPollQuestionAnswersMaxSelectionsPollKindClosure?(
      question, answers, maxSelections, pollKind)
  }
  ...
  open var editEventOrTransactionIdNewContentReceivedArguments:
    (eventOrTransactionId: EventOrTransactionId, newContent: EditedContent)?
  open var editEventOrTransactionIdNewContentReceivedInvocations:
    [(eventOrTransactionId: EventOrTransactionId, newContent: EditedContent)] = []
  open var editEventOrTransactionIdNewContentClosure:
    ((EventOrTransactionId, EditedContent) async throws -> Void)?

  open override func edit(eventOrTransactionId: EventOrTransactionId, newContent: EditedContent)
    async throws
  {
    ...
    editEventOrTransactionIdNewContentReceivedArguments = (
      eventOrTransactionId: eventOrTransactionId, newContent: newContent
    )
    DispatchQueue.main.async {
      self.editEventOrTransactionIdNewContentReceivedInvocations.append(
        (eventOrTransactionId: eventOrTransactionId, newContent: newContent))
    }
  ...
  open override func endPoll(pollStartEventId: String, text: String) async throws {
    ...
    DispatchQueue.main.async {
      self.endPollPollStartEventIdTextReceivedInvocations.append(
        (pollStartEventId: pollStartEventId, text: text))
    }
  ...
  open var getEventTimelineItemByEventIdEventIdClosure:
    ((String) async throws -> EventTimelineItem)?

  open override func getEventTimelineItemByEventId(eventId: String) async throws
    -> EventTimelineItem
  {
  ...
  open var redactEventEventOrTransactionIdReasonReceivedArguments:
    (eventOrTransactionId: EventOrTransactionId, reason: String?)?
  open var redactEventEventOrTransactionIdReasonReceivedInvocations:
    [(eventOrTransactionId: EventOrTransactionId, reason: String?)] = []
  open var redactEventEventOrTransactionIdReasonClosure:
    ((EventOrTransactionId, String?) async throws -> Void)?

  open override func redactEvent(eventOrTransactionId: EventOrTransactionId, reason: String?)
    async throws
  {
    ...
    redactEventEventOrTransactionIdReasonReceivedArguments = (
      eventOrTransactionId: eventOrTransactionId, reason: reason
    )
    DispatchQueue.main.async {
      self.redactEventEventOrTransactionIdReasonReceivedInvocations.append(
        (eventOrTransactionId: eventOrTransactionId, reason: reason))
    }
  ...
  open var sendAudioParamsAudioInfoReceivedArguments:
    (params: UploadParameters, audioInfo: AudioInfo)?
  open var sendAudioParamsAudioInfoReceivedInvocations:
    [(params: UploadParameters, audioInfo: AudioInfo)] = []
  ...
  open var sendAudioParamsAudioInfoClosure:
    ((UploadParameters, AudioInfo) throws -> SendAttachmentJoinHandle)?

  open override func sendAudio(params: UploadParameters, audioInfo: AudioInfo) throws
    -> SendAttachmentJoinHandle
  {
    ...
    DispatchQueue.main.async {
      self.sendAudioParamsAudioInfoReceivedInvocations.append(
        (params: params, audioInfo: audioInfo))
    }
  ...
  open var sendFileParamsFileInfoReceivedInvocations:
    [(params: UploadParameters, fileInfo: FileInfo)] = []
  ...
  open var sendFileParamsFileInfoClosure:
    ((UploadParameters, FileInfo) throws -> SendAttachmentJoinHandle)?

  open override func sendFile(params: UploadParameters, fileInfo: FileInfo) throws
    -> SendAttachmentJoinHandle
  {
  ...
  open var sendImageParamsThumbnailSourceImageInfoReceivedArguments:
    (params: UploadParameters, thumbnailSource: UploadSource?, imageInfo: ImageInfo)?
  open var sendImageParamsThumbnailSourceImageInfoReceivedInvocations:
    [(params: UploadParameters, thumbnailSource: UploadSource?, imageInfo: ImageInfo)] = []
  ...
  open var sendImageParamsThumbnailSourceImageInfoClosure:
    ((UploadParameters, UploadSource?, ImageInfo) throws -> SendAttachmentJoinHandle)?

  open override func sendImage(
    params: UploadParameters, thumbnailSource: UploadSource?, imageInfo: ImageInfo
    ...
    sendImageParamsThumbnailSourceImageInfoReceivedArguments = (
      params: params, thumbnailSource: thumbnailSource, imageInfo: imageInfo
    )
    DispatchQueue.main.async {
      self.sendImageParamsThumbnailSourceImageInfoReceivedInvocations.append(
        (params: params, thumbnailSource: thumbnailSource, imageInfo: imageInfo))
    }
    if let sendImageParamsThumbnailSourceImageInfoClosure =
      sendImageParamsThumbnailSourceImageInfoClosure
    {
  ...
  open var sendLocationBodyGeoUriDescriptionZoomLevelAssetTypeRepliedToEventIdUnderlyingCallsCount =
    0
  open var sendLocationBodyGeoUriDescriptionZoomLevelAssetTypeRepliedToEventIdCallsCount: Int {
    get {
      if Thread.isMainThread {
        return
          sendLocationBodyGeoUriDescriptionZoomLevelAssetTypeRepliedToEventIdUnderlyingCallsCount
      } else {
        var returnValue: Int? = nil
        DispatchQueue.main.sync {
          returnValue =
  ...
  open var sendLocationBodyGeoUriDescriptionZoomLevelAssetTypeRepliedToEventIdReceivedArguments:
    (
      body: String, geoUri: String, description: String?, zoomLevel: UInt8?, assetType: AssetType?,
      repliedToEventId: String?
    )?
  open var sendLocationBodyGeoUriDescriptionZoomLevelAssetTypeRepliedToEventIdReceivedInvocations:
    [(
      body: String, geoUri: String, description: String?, zoomLevel: UInt8?, assetType: AssetType?,
      repliedToEventId: String?
    )] = []
  open var sendLocationBodyGeoUriDescriptionZoomLevelAssetTypeRepliedToEventIdClosure:
    ((String, String, String?, UInt8?, AssetType?, String?) async throws -> Void)?
  ...
  open override func sendLocation(
    ...
    sendLocationBodyGeoUriDescriptionZoomLevelAssetTypeRepliedToEventIdReceivedArguments = (
      body: body, geoUri: geoUri, description: description, zoomLevel: zoomLevel,
      assetType: assetType, repliedToEventId: repliedToEventId
    )
    DispatchQueue.main.async {
      self.sendLocationBodyGeoUriDescriptionZoomLevelAssetTypeRepliedToEventIdReceivedInvocations
        .append(
          (
            body: body, geoUri: geoUri, description: description, zoomLevel: zoomLevel,
            assetType: assetType, repliedToEventId: repliedToEventId
    ...
    try await sendLocationBodyGeoUriDescriptionZoomLevelAssetTypeRepliedToEventIdClosure?(
      body, geoUri, description, zoomLevel, assetType, repliedToEventId)
  }
  ...
  open var sendPollResponsePollStartEventIdAnswersReceivedArguments:
    (pollStartEventId: String, answers: [String])?
  open var sendPollResponsePollStartEventIdAnswersReceivedInvocations:
    [(pollStartEventId: String, answers: [String])] = []
  open var sendPollResponsePollStartEventIdAnswersClosure:
    ((String, [String]) async throws -> Void)?
  ...
  open override func sendPollResponse(pollStartEventId: String, answers: [String]) async throws {
    ...
    sendPollResponsePollStartEventIdAnswersReceivedArguments = (
      pollStartEventId: pollStartEventId, answers: answers
    )
    DispatchQueue.main.async {
      self.sendPollResponsePollStartEventIdAnswersReceivedInvocations.append(
        (pollStartEventId: pollStartEventId, answers: answers))
    }
  ...
  open var sendReadReceiptReceiptTypeEventIdReceivedArguments:
    (receiptType: ReceiptType, eventId: String)?
  open var sendReadReceiptReceiptTypeEventIdReceivedInvocations:
    [(receiptType: ReceiptType, eventId: String)] = []
  ...
  open override func sendReadReceipt(receiptType: ReceiptType, eventId: String) async throws {
    ...
    sendReadReceiptReceiptTypeEventIdReceivedArguments = (
      receiptType: receiptType, eventId: eventId
    )
    DispatchQueue.main.async {
      self.sendReadReceiptReceiptTypeEventIdReceivedInvocations.append(
        (receiptType: receiptType, eventId: eventId))
    }
  ...
  open var sendReplyMsgEventIdReceivedArguments:
    (msg: RoomMessageEventContentWithoutRelation, eventId: String)?
  open var sendReplyMsgEventIdReceivedInvocations:
    [(msg: RoomMessageEventContentWithoutRelation, eventId: String)] = []
  open var sendReplyMsgEventIdClosure:
    ((RoomMessageEventContentWithoutRelation, String) async throws -> Void)?

  open override func sendReply(msg: RoomMessageEventContentWithoutRelation, eventId: String)
    async throws
  {
  ...
  open var sendVideoParamsThumbnailSourceVideoInfoReceivedArguments:
    (params: UploadParameters, thumbnailSource: UploadSource?, videoInfo: VideoInfo)?
  open var sendVideoParamsThumbnailSourceVideoInfoReceivedInvocations:
    [(params: UploadParameters, thumbnailSource: UploadSource?, videoInfo: VideoInfo)] = []
  ...
  open var sendVideoParamsThumbnailSourceVideoInfoClosure:
    ((UploadParameters, UploadSource?, VideoInfo) throws -> SendAttachmentJoinHandle)?

  open override func sendVideo(
    params: UploadParameters, thumbnailSource: UploadSource?, videoInfo: VideoInfo
  ) throws -> SendAttachmentJoinHandle {
    ...
    sendVideoParamsThumbnailSourceVideoInfoReceivedArguments = (
      params: params, thumbnailSource: thumbnailSource, videoInfo: videoInfo
    )
    DispatchQueue.main.async {
      self.sendVideoParamsThumbnailSourceVideoInfoReceivedInvocations.append(
        (params: params, thumbnailSource: thumbnailSource, videoInfo: videoInfo))
    }
    if let sendVideoParamsThumbnailSourceVideoInfoClosure =
      sendVideoParamsThumbnailSourceVideoInfoClosure
    {
  ...
  open var sendVoiceMessageParamsAudioInfoWaveformReceivedArguments:
    (params: UploadParameters, audioInfo: AudioInfo, waveform: [Float])?
  open var sendVoiceMessageParamsAudioInfoWaveformReceivedInvocations:
    [(params: UploadParameters, audioInfo: AudioInfo, waveform: [Float])] = []
  ...
  open var sendVoiceMessageParamsAudioInfoWaveformClosure:
    ((UploadParameters, AudioInfo, [Float]) throws -> SendAttachmentJoinHandle)?

  open override func sendVoiceMessage(
    params: UploadParameters, audioInfo: AudioInfo, waveform: [Float]
  ) throws -> SendAttachmentJoinHandle {
    ...
    sendVoiceMessageParamsAudioInfoWaveformReceivedArguments = (
      params: params, audioInfo: audioInfo, waveform: waveform
    )
    DispatchQueue.main.async {
      self.sendVoiceMessageParamsAudioInfoWaveformReceivedInvocations.append(
        (params: params, audioInfo: audioInfo, waveform: waveform))
    }
    if let sendVoiceMessageParamsAudioInfoWaveformClosure =
      sendVoiceMessageParamsAudioInfoWaveformClosure
    {
  ...
  open var subscribeToBackPaginationStatusListenerClosure:
    ((PaginationStatusListener) async throws -> TaskHandle)?

  open override func subscribeToBackPaginationStatus(listener: PaginationStatusListener)
    async throws -> TaskHandle
  {
    ...
    if let subscribeToBackPaginationStatusListenerClosure =
      subscribeToBackPaginationStatusListenerClosure
    {
  ...
  open var toggleReactionItemIdKeyReceivedInvocations:
    [(itemId: EventOrTransactionId, key: String)] = []
  ...
  open var sendGalleryParamsItemInfosReceivedArguments:
    (params: GalleryUploadParameters, itemInfos: [GalleryItemInfo])?
  open var sendGalleryParamsItemInfosReceivedInvocations:
    [(params: GalleryUploadParameters, itemInfos: [GalleryItemInfo])] = []
  ...
  open var sendGalleryParamsItemInfosClosure:
    ((GalleryUploadParameters, [GalleryItemInfo]) throws -> SendGalleryJoinHandle)?

  open override func sendGallery(params: GalleryUploadParameters, itemInfos: [GalleryItemInfo])
    throws -> SendGalleryJoinHandle
  {
    ...
    DispatchQueue.main.async {
      self.sendGalleryParamsItemInfosReceivedInvocations.append(
        (params: params, itemInfos: itemInfos))
    }
...
open class WidgetDriverSDKMock: MatrixRustSDK.WidgetDriver, @unchecked Sendable {
  ...
  open var runRoomCapabilitiesProviderReceivedArguments:
    (room: Room, capabilitiesProvider: WidgetCapabilitiesProvider)?
  open var runRoomCapabilitiesProviderReceivedInvocations:
    [(room: Room, capabilitiesProvider: WidgetCapabilitiesProvider)] = []
  ...
  open override func run(room: Room, capabilitiesProvider: WidgetCapabilitiesProvider) async {
    ...
    runRoomCapabilitiesProviderReceivedArguments = (
      room: room, capabilitiesProvider: capabilitiesProvider
    )
    DispatchQueue.main.async {
      self.runRoomCapabilitiesProviderReceivedInvocations.append(
        (room: room, capabilitiesProvider: capabilitiesProvider))
    }
