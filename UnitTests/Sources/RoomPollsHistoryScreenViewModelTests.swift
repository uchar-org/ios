...
struct RoomPollsHistoryScreenViewModelTests {
    ...
    func backPaginate() async throws {
        ...
        let deferredViewState = deferFulfillment(viewModel.context.$viewState, keyPath: \.isBackPaginating,
    ...
    func sendPollResponse() async throws {
        ...
        #expect(interactionHandler.sendPollResponsePollStartIDOptionIDReceivedInvocations[0].pollStartID
            == "somePollID")
        #expect(interactionHandler.sendPollResponsePollStartIDOptionIDReceivedInvocations[0].optionID
            == "someOptionID")
    }
