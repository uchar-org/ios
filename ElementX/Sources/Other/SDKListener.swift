...
extension SDKListener: GrantGeneratedQrLoginProgressListener
...
extension SDKListener: RoomListServiceSyncIndicatorListener
where T == RoomListServiceSyncIndicator {
...
extension SDKListener: SpaceRoomListPaginationStateListener
where T == SpaceRoomListPaginationState {
...
extension SDKListener: RoomDirectorySearchEntriesListener
where T == [RoomDirectorySearchEntryUpdate] {
