...
struct RoomMessageEventStringBuilder {
  ...
  func buildAttributedString(
    for messageType: MessageType, senderDisplayName: String, isOutgoing: Bool
  ) -> AttributedString {
  ...
  func buildAttributedStringForLiveLocation(senderDisplayName: String, isOutgoing: Bool)
    -> AttributedString
  {
