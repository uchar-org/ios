...
class NavigationTabCoordinator<Tag: Hashable>: CoordinatorProtocol, CustomStringConvertible {
  ...
  @Observable class TabDetails {
    ...
    init(
      tag: Tag, title: String, icon: KeyPath<CompoundIcons, Image>,
  ...
  func setTabs(_ tabs: [Tab], animated: Bool = true) {
    ...
    withTransaction(transaction) {
      tabModules = tabs.map {
        TabModule(
          module: .init($0.coordinator, dismissalCallback: $0.dismissalCallback),
          details: $0.details)
      }
    }
  ...
  func setSheetCoordinator(
    _ coordinator: (any CoordinatorProtocol)?, animated: Bool = true,
  ...
  func setFullScreenCoverCoordinator(
    _ coordinator: (any CoordinatorProtocol)?, animated: Bool = true,
    dismissalCallback: (() -> Void)? = nil
  ) {
    guard let coordinator else {
  ...
  func setOverlayCoordinator(
    _ coordinator: (any CoordinatorProtocol)?,
...
private struct NavigationTabCoordinatorView<Tag: Hashable>: View {
  ...
  var body: some View {
        ...
        module.coordinator?.toPresentable()
          ...
          .tabItem {
            Label {
              ...
              CompoundIcon(
                module.details.tag == navigationTabCoordinator.selectedTab
    ...
    .accessibilityHidden(
      navigationTabCoordinator.overlayModule?.coordinator != nil
