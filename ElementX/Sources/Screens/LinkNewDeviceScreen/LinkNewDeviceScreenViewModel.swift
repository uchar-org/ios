...
typealias LinkNewDeviceScreenViewModelType = StateStoreViewModelV2<
  LinkNewDeviceScreenViewState, LinkNewDeviceScreenViewAction
>
  ...
  LinkNewDeviceScreenViewModelProtocol
{
  ...
  private let actionsSubject: PassthroughSubject<LinkNewDeviceScreenViewModelAction, Never> =
    .init()
  ...
  init(clientProxy: ClientProxyProtocol, initialState: LinkNewDeviceScreenViewState? = nil) {
    ...
    super.init(
      initialViewState: LinkNewDeviceScreenViewState(
        showLinkDesktopComputerButton: isQRCodeScanningSupported))
