...
struct VerificationBadge: View {
  ...
  init(
    verificationState: UserIdentityVerificationState, size: CompoundIcon.Size, relativeTo font: Font
  ) {
...
struct VerificationBadge_Previews: PreviewProvider, TestablePreview {
  static var previews: some View {
    VStack(spacing: 20) {
      ...
      HStack(spacing: 16) {
        VerificationBadge(
          verificationState: .notVerified, size: .xSmall, relativeTo: .compound.bodyMD)
        VerificationBadge(
          verificationState: .verificationViolation, size: .xSmall, relativeTo: .compound.bodyMD)
