...
final class AnalyticsTests {
  ...
  func addingUserProperties() {
    ...
    client.updateUserProperties(
      AnalyticsEvent.UserProperties(
        URLPreviewsEnabled: nil,
    ...
    #expect(
      client.pendingUserProperties?.ftueUseCaseSelection == .PersonalMessaging,
      "The use case selection should match.")
    #expect(
      client.pendingUserProperties?.numFavouriteRooms == 4,
      "The number of favorite rooms should match.")
    #expect(client.pendingUserProperties?.numSpaces == 5, "The number of spaces should match.")
    #expect(
      client.pendingUserProperties?.verificationState
        == AnalyticsEvent.UserProperties.VerificationState.Verified,
      "The verification state should match.")
    #expect(
      client.pendingUserProperties?.recoveryState
        == AnalyticsEvent.UserProperties.RecoveryState.Disabled, "The recovery state should match.")
  }
  ...
  func mergingUserProperties() {
    ...
    #expect(
      ...
      "The use case selection should match.")
    #expect(
      client.pendingUserProperties?.numFavouriteRooms == nil,
      "The number of favorite rooms should not be set.")
    #expect(
      client.pendingUserProperties?.numSpaces == nil, "The number of spaces should not be set.")
    ...
    #expect(
      client.pendingUserProperties?.ftueUseCaseSelection == .PersonalMessaging,
      "The use case selection shouldn't have changed.")
    #expect(
      client.pendingUserProperties?.numFavouriteRooms == 4,
      "The number of favorite rooms should have been updated.")
    #expect(
      client.pendingUserProperties?.numSpaces == 5, "The number of spaces should have been updated."
    )
  }
  ...
  func sendingUserProperties() throws {
    ...
    let someEvent = AnalyticsEvent.Error(
      context: nil,
      cryptoModule: .Rust,
      cryptoSDK: .Rust,
      domain: .E2EE,
    ...
    #expect(
      capturedEvent?.userProperties?["ftueUseCaseSelection"] as? String
        == AnalyticsEvent.UserProperties.FtueUseCaseSelection.PersonalMessaging.rawValue)
  ...
  func sendingAndUpdatingSuperProperties() throws {
    ...
    #expect(
      screenEvent?.properties?["cryptoSDK"] as? String
        == AnalyticsEvent.SuperProperties.CryptoSDK.Rust.rawValue)
    ...
    // All the super properties should have been added
    #expect(
      capturedEvent?.properties?["cryptoSDK"] as? String
        == AnalyticsEvent.SuperProperties.CryptoSDK.Rust.rawValue)
    ...
    #expect(
      capturedEvent2?.properties?["cryptoSDK"] as? String
        == AnalyticsEvent.SuperProperties.CryptoSDK.Rust.rawValue)
